    ...
    public sealed class LuaAssetDatabaseType : global::Luny.ILuaStatic
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaAssetDatabase_AddObjectToAsset = new global::Lua.LuaFunction("AddObjectToAsset", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaUnityObject>(out var _p0_UnityEngine_Object))
            {
                ...
                if (_arg1.TryRead<global::System.String>(out var _p1_System_String))
                {
                    if (_argCount == 2)
                    {
                        var objectToAdd = _p0_UnityEngine_Object.Instance;
                ...
                if (_arg1.TryRead<global::Luny.UnityEngine.LuaUnityObject>(out var _p1_UnityEngine_Object))
                {
                    ...
                    {
                        var objectToAdd = _p0_UnityEngine_Object.Instance;
                        var assetObject = _p1_UnityEngine_Object.Instance;
        ...
        private static readonly global::Lua.LuaFunction _LuaAssetDatabase_CanOpenForEdit = new global::Lua.LuaFunction("CanOpenForEdit", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaUnityObject>(out var _p0_UnityEngine_Object))
            {
                if (_argCount == 1)
                {
                    var assetObject = _p0_UnityEngine_Object.Instance;
        ...
        private static readonly global::Lua.LuaFunction _LuaAssetDatabase_FindAssetGUIDs = new global::Lua.LuaFunction("FindAssetGUIDs", (_context, _) =>
        {
            global::Lua.LuaValue _lastArg = default;
            global::System.Int32 _lastArgPos = default;
            global::System.Type _expectedType = default;
            ...
            if (_arg0.TryRead<global::System.String>(out var _p0_System_String))
            {
                if (_argCount == 1)
                {
                    ...
                    var _ret0 = global::UnityEditor.AssetDatabase.FindAssetGUIDs(filter);
                    var _factory = _context.GetObjectFactory();
                    var _lret0 = _factory.Bind(_ret0);
                    var _retCount = _context.Return(_lret0);
                    return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                ...
                if (_arg1.TryReadArray<global::System.String>(out var _p1_System_StringArray))
                {
                    if (_argCount == 2)
                    {
                        ...
                        var _ret0 = global::UnityEditor.AssetDatabase.FindAssetGUIDs(filter, searchInFolders);
                        var _factory = _context.GetObjectFactory();
                        var _lret0 = _factory.Bind(_ret0);
                        var _retCount = _context.Return(_lret0);
                        return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
            ...
            throw new global::Lua.LuaRuntimeException(_context.Thread, $"{"FindAssetGUIDs"}: invalid argument #{_lastArgPos}: {_lastArg} ({_lastArg.Type}), expected: {_expectedType.FullName}", 2);
        });
        ...
        private static readonly global::Lua.LuaFunction _LuaAssetDatabase_LoadAssetByGUID = new global::Lua.LuaFunction("LoadAssetByGUID", (_context, _) =>
        {
            global::Lua.LuaValue _lastArg = default;
            global::System.Int32 _lastArgPos = default;
            global::System.Type _expectedType = default;
            ...
            if (_arg0.TryRead<global::LunyEditor.UnityEditor.LuaGUID>(out var _p0_UnityEditor_GUID))
            {
                ...
                if (_arg1.TryRead<global::Luny.ILuaBindType>(out var _p1_System_Type))
                {
                    if (_argCount == 2)
                    {
                        var assetGUID = _p0_UnityEditor_GUID.Value;
                        var type = _p1_System_Type.BindType;
                        var _ret0 = global::UnityEditor.AssetDatabase.LoadAssetByGUID(assetGUID, type);
                        var _factory = _context.GetObjectFactory();
                        var _lret0 = _factory.Bind(_ret0);
                        var _retCount = _context.Return(_lret0);
                        return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
            ...
            throw new global::Lua.LuaRuntimeException(_context.Thread, $"{"LoadAssetByGUID"}: invalid argument #{_lastArgPos}: {_lastArg} ({_lastArg.Type}), expected: {_expectedType.FullName}", 2);
        });
            ...
            if (_arg0.TryRead<global::System.String>(out var _p0_System_String))
            {
                ...
                if (_arg1.TryRead<global::Luny.UnityEngine.LuaHash128>(out var _p1_UnityEngine_Hash128))
                {
                    if (_argCount == 2)
                    {
                        ...
                        var hashOfValue = _p1_UnityEngine_Hash128.Value;
        ...
        private static readonly global::Lua.LuaFunction _LuaAssetDatabase_RemoveObjectFromAsset = new global::Lua.LuaFunction("RemoveObjectFromAsset", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaUnityObject>(out var _p0_UnityEngine_Object))
            {
                if (_argCount == 1)
                {
                    var objectToRemove = _p0_UnityEngine_Object.Instance;
        ...
        private static readonly global::Lua.LuaFunction _LuaAssetDatabase_SetMainObject = new global::Lua.LuaFunction("SetMainObject", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaUnityObject>(out var _p0_UnityEngine_Object))
            {
                ...
                if (_arg1.TryRead<global::System.String>(out var _p1_System_String))
                {
                    if (_argCount == 2)
                    {
                        var mainObject = _p0_UnityEngine_Object.Instance;
        ...
        private static global::Lua.LuaTable CreateMetatable()
        {
            ...
            metatable[global::Lua.Runtime.Metamethods.Concat] = global::Luny.LuaMetatable.ConcatMetamethod;
            metatable[global::Lua.Runtime.Metamethods.ToString] = global::Luny.LuaMetatable.ToStringMetamethod;
            metatable[global::Lua.Runtime.Metamethods.Call] = _LuaAssetDatabase_new;
            return metatable;
        }
        private static global::Lua.LuaTable s_Metatable;
        public global::Lua.LuaTable Metatable
        ...
        public global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                ...
                case "FindAssetGUIDs": _value = _LuaAssetDatabase_FindAssetGUIDs; return true;
                ...
                case "LoadAssetByGUID": _value = _LuaAssetDatabase_LoadAssetByGUID; return true;
