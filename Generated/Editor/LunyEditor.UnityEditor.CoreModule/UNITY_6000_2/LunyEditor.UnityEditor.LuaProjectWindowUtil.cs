...
{
    public class LuaProjectWindowUtil : global::Luny.ILuaObject<global::UnityEditor.ProjectWindowUtil>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::System.Object> instances) =>
            new global::Luny.LuaList<global::UnityEditor.ProjectWindowUtil>(instances);
        protected LuaProjectWindowUtil(global::UnityEditor.ProjectWindowUtil instance) => m_Instance = instance;
        public static implicit operator global::Lua.LuaValue(LuaProjectWindowUtil value) => new(value);
        protected global::UnityEditor.ProjectWindowUtil m_Instance;
    ...
    public sealed class LuaProjectWindowUtilType : global::Luny.ILuaStatic
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaProjectWindowUtil_CreateAssetWithContent = new global::Lua.LuaFunction("CreateAssetWithContent", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::System.String>(out var _p0_System_String))
            {
                ...
                if (_arg1.TryRead<global::System.String>(out var _p1_System_String))
                {
                    ...
                    var _p2_UnityEngine_Texture2D = _arg2.ReadValue<global::Luny.UnityEngine.LuaTexture2D>(default);
                    {
                        if (_argCount == 3)
                        {
                            var filename = _p0_System_String;
                            var content = _p1_System_String;
                            var icon = _p2_UnityEngine_Texture2D.Instance;
        ...
        private static readonly global::Lua.LuaFunction _LuaProjectWindowUtil_StartNameEditingIfProjectWindowExists = new global::Lua.LuaFunction("StartNameEditingIfProjectWindowExists", (_context, _) =>
        {
            ...
            {
                var _arg1 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::LunyEditor.UnityEditor.ProjectWindowCallback.LuaEndNameEditAction);
                if (_arg1.TryRead<global::LunyEditor.UnityEditor.ProjectWindowCallback.LuaEndNameEditAction>(out var _p1_UnityEditor_ProjectWindowCallback_EndNameEditAction))
                {
                    var _arg2 = _lastArg = _argCount > 2 ? _context.GetArgument(2) : global::Lua.LuaValue.Nil;
                    ...
                    if (_arg2.TryRead<global::System.String>(out var _p2_System_String))
                    {
                        ...
                        _lastArgPos = 3; _expectedType = typeof(global::Luny.UnityEngine.LuaTexture2D);
                        if (_arg3.TryRead<global::Luny.UnityEngine.LuaTexture2D>(out var _p3_UnityEngine_Texture2D))
                        {
                            ...
                            if (_arg4.TryRead<global::System.String>(out var _p4_System_String))
                            {
                                if (_argCount == 5)
                                {
                                    ...
                                    var icon = _p3_UnityEngine_Texture2D.Instance;
        ...
        private static global::Lua.LuaTable CreateMetatable()
        {
            ...
            metatable[global::Lua.Runtime.Metamethods.Concat] = global::Luny.LuaMetatable.ConcatMetamethod;
            metatable[global::Lua.Runtime.Metamethods.ToString] = global::Luny.LuaMetatable.ToStringMetamethod;
            metatable[global::Lua.Runtime.Metamethods.Call] = _LuaProjectWindowUtil_new;
            return metatable;
        }
        private static global::Lua.LuaTable s_Metatable;
        public global::Lua.LuaTable Metatable
