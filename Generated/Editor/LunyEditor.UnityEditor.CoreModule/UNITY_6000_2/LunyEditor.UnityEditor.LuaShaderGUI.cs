...
{
    public class LuaShaderGUI : global::Luny.ILuaObject<global::UnityEditor.ShaderGUI>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::System.Object> instances) =>
            new global::Luny.LuaList<global::UnityEditor.ShaderGUI>(instances);
        protected LuaShaderGUI(global::UnityEditor.ShaderGUI instance) => m_Instance = instance;
        public static implicit operator global::Lua.LuaValue(LuaShaderGUI value) => new(value);
        protected global::UnityEditor.ShaderGUI m_Instance;
        ...
        private static readonly global::Lua.LuaFunction _LuaShaderGUI_AssignNewShaderToMaterial = new global::Lua.LuaFunction("AssignNewShaderToMaterial", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaMaterial>(out var _p0_UnityEngine_Material))
            {
                ...
                if (_arg1.TryRead<global::Luny.UnityEngine.LuaShader>(out var _p1_UnityEngine_Shader))
                {
                    ...
                    _lastArgPos = 2; _expectedType = typeof(global::Luny.UnityEngine.LuaShader);
                    if (_arg2.TryRead<global::Luny.UnityEngine.LuaShader>(out var _p2_UnityEngine_Shader))
                    {
                        if (_argCount == 4)
                        {
                            var material = _p0_UnityEngine_Material.Instance;
                            var oldShader = _p1_UnityEngine_Shader.Instance;
                            var newShader = _p2_UnityEngine_Shader.Instance;
        ...
        private static readonly global::Lua.LuaFunction _LuaShaderGUI_OnGUI = new global::Lua.LuaFunction("OnGUI", (_context, _) =>
        {
            ...
            var _this = _context.GetArgument<LuaShaderGUI>(0);
            var _arg0 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
            _lastArgPos = 0; _expectedType = typeof(global::LunyEditor.UnityEditor.LuaMaterialEditor);
            if (_arg0.TryRead<global::LunyEditor.UnityEditor.LuaMaterialEditor>(out var _p0_UnityEditor_MaterialEditor))
            {
                var _arg1 = _lastArg = _argCount > 2 ? _context.GetArgument(2) : global::Lua.LuaValue.Nil;
            ...
            if (_arg0.TryRead<global::LunyEditor.UnityEditor.LuaMaterialEditor>(out var _p0_UnityEditor_MaterialEditor))
            {
                ...
                if (_arg1.TryRead<global::Luny.UnityEngine.LuaRect>(out var _p1_UnityEngine_Rect))
                {
                    ...
                    if (_arg2.TryRead<global::UnityEngine.GUIStyle>(out var _p2_UnityEngine_GUIStyle))
                    {
                        ...
                        {
                            var materialEditor = _p0_UnityEditor_MaterialEditor.Instance;
                            var r = _p1_UnityEngine_Rect.Value;
