...
namespace LunyEditor.UnityEditor
{
    public sealed class LuaGizmoUtilityType : global::Luny.ILuaStatic
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaGizmoUtility_ApplyGizmoInfo = new global::Lua.LuaFunction("ApplyGizmoInfo", (_context, _) =>
        {
            ...
            _lastArgPos = 0; _expectedType = typeof(global::LunyEditor.UnityEditor.LuaGizmoInfo);
            if (_arg0.TryRead<global::LunyEditor.UnityEditor.LuaGizmoInfo>(out var _p0_UnityEditor_GizmoInfo))
            {
                if (_argCount == 1)
                {
