...
namespace LunyEditor.UnityEditor.Rendering
{
    ...
    public sealed class LuaEditorGraphicsSettingsType : global::Luny.ILuaStatic
    {
            ...
            if (_arg0.TryRead<global::UnityEditor.BuildTargetGroup>(out var _p0_UnityEditor_BuildTargetGroup))
            {
                ...
                if (_arg1.TryRead<global::UnityEngine.Rendering.GraphicsTier>(out var _p1_UnityEngine_Rendering_GraphicsTier))
                {
                    if (_argCount == 2)
                    {
                        ...
                        var _lret0 = global::LunyEditor.UnityEditor.Rendering.LuaTierSettings.Bind(_ret0);
                        var _retCount = _context.Return(_lret0);
                        return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                    }
                }
        ...
        private static readonly global::Lua.LuaFunction _LuaEditorGraphicsSettings_PopulateRenderPipelineGraphicsSettings = new global::Lua.LuaFunction("PopulateRenderPipelineGraphicsSettings", (_context, _) =>
        {
            ...
            var _argCount = _context.ArgumentCount;
            var _arg0 = _lastArg = _argCount > 0 ? _context.GetArgument(0) : global::Lua.LuaValue.Nil;
            _lastArgPos = 0; _expectedType = typeof(global::Luny.UnityEngine.Rendering.LuaRenderPipelineGlobalSettings);
            if (_arg0.TryRead<global::Luny.UnityEngine.Rendering.LuaRenderPipelineGlobalSettings>(out var _p0_UnityEngine_Rendering_RenderPipelineGlobalSettings))
            {
                if (_argCount == 1)
                {
                    var settings = _p0_UnityEngine_Rendering_RenderPipelineGlobalSettings.Instance;
        ...
        private static readonly global::Lua.LuaFunction _LuaEditorGraphicsSettings_SetRenderPipelineGlobalSettingsAsset = new global::Lua.LuaFunction("SetRenderPipelineGlobalSettingsAsset", (_context, _) =>
        {
            ...
            {
                var _arg1 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::Luny.UnityEngine.Rendering.LuaRenderPipelineGlobalSettings);
                if (_arg1.TryRead<global::Luny.UnityEngine.Rendering.LuaRenderPipelineGlobalSettings>(out var _p1_UnityEngine_Rendering_RenderPipelineGlobalSettings))
                {
                    if (_argCount == 2)
                    {
                        var renderPipelineType = _p0_System_Type.BindType;
                        var newSettings = _p1_UnityEngine_Rendering_RenderPipelineGlobalSettings.Instance;
        ...
        private static readonly global::Lua.LuaFunction _LuaEditorGraphicsSettings_SetTierSettings = new global::Lua.LuaFunction("SetTierSettings", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::UnityEditor.BuildTargetGroup>(out var _p0_UnityEditor_BuildTargetGroup))
            {
                ...
                if (_arg1.TryRead<global::UnityEngine.Rendering.GraphicsTier>(out var _p1_UnityEngine_Rendering_GraphicsTier))
                {
                    ...
                    _lastArgPos = 2; _expectedType = typeof(global::LunyEditor.UnityEditor.Rendering.LuaTierSettings);
                    if (_arg2.TryRead<global::LunyEditor.UnityEditor.Rendering.LuaTierSettings>(out var _p2_UnityEditor_Rendering_TierSettings))
                    {
                        if (_argCount == 3)
                        {
                            var target = _p0_UnityEditor_BuildTargetGroup;
        ...
        private static global::Lua.LuaTable CreateMetatable()
        {
            ...
            metatable[global::Lua.Runtime.Metamethods.Concat] = global::Luny.LuaMetatable.ConcatMetamethod;
            metatable[global::Lua.Runtime.Metamethods.ToString] = global::Luny.LuaMetatable.ToStringMetamethod;
            metatable[global::Lua.Runtime.Metamethods.Call] = _LuaEditorGraphicsSettings_new;
            return metatable;
        }
        private static global::Lua.LuaTable s_Metatable;
        public global::Lua.LuaTable Metatable
