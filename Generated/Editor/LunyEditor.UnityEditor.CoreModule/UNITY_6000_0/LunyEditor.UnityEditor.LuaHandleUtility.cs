    ...
    public sealed class LuaHandleUtilityType : global::Luny.ILuaStatic
    {
                ...
                if (_arg1.TryRead<global::Luny.UnityEngine.LuaVector2>(out var _p1_UnityEngine_Vector2))
                {
                    ...
                    if (_arg2.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p2_UnityEngine_Vector3))
                    {
                        ...
                        if (_arg3.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p3_UnityEngine_Vector3))
                        {
                            if (_argCount == 4)
                            {
                                var src = _p0_UnityEngine_Vector2.Value;
                                var dest = _p1_UnityEngine_Vector2.Value;
                                var srcPosition = _p2_UnityEngine_Vector3.Value;
                                var constraintDir = _p3_UnityEngine_Vector3.Value;
                        ...
                        if (_arg3.TryRead<global::System.Single>(out var _p3_System_Single))
                        {
                            ...
                            if (_arg4.TryRead<global::System.Single>(out var _p4_System_Single))
                            {
                                if (_argCount == 5)
                                {
                                    ...
                                    var normal = _p1_UnityEngine_Vector3.Value;
                                    var from = _p2_UnityEngine_Vector3.Value;
        ...
        private static readonly global::Lua.LuaFunction _LuaHandleUtility_DecodeSelectionId = new global::Lua.LuaFunction("DecodeSelectionId", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaVector4>(out var _p0_UnityEngine_Vector4))
            {
                if (_argCount == 1)
                {
                    var selectionId = _p0_UnityEngine_Vector4.Value;
                        ...
                        if (_arg3.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p3_UnityEngine_Vector3))
                        {
                            ...
                            if (_arg4.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p4_UnityEngine_Vector3))
                            {
                                if (_argCount == 5)
                                {
                                    ...
                                    var startPosition = _p1_UnityEngine_Vector3.Value;
                                    var endPosition = _p2_UnityEngine_Vector3.Value;
                                    var startTangent = _p3_UnityEngine_Vector3.Value;
                                    var endTangent = _p4_UnityEngine_Vector3.Value;
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p0_UnityEngine_Vector3))
            {
                ...
                if (_arg1.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p1_UnityEngine_Vector3))
                {
                    ...
                    if (_arg2.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p2_UnityEngine_Vector3))
                    {
                        ...
                        {
                            var point = _p0_UnityEngine_Vector3.Value;
                            var lineStart = _p1_UnityEngine_Vector3.Value;
                            var lineEnd = _p2_UnityEngine_Vector3.Value;
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaVector2>(out var _p0_UnityEngine_Vector2))
            {
                ...
                if (_arg1.TryRead<global::Luny.UnityEngine.LuaVector2>(out var _p1_UnityEngine_Vector2))
                {
                    ...
                    if (_arg2.TryRead<global::Luny.UnityEngine.LuaVector2>(out var _p2_UnityEngine_Vector2))
                    {
                        if (_argCount == 3)
                        {
                            var p = _p0_UnityEngine_Vector2.Value;
                            var a = _p1_UnityEngine_Vector2.Value;
                            var b = _p2_UnityEngine_Vector2.Value;
        ...
        private static readonly global::Lua.LuaFunction _LuaHandleUtility_DistanceToCircle = new global::Lua.LuaFunction("DistanceToCircle", (_context, _) =>
        {
            ...
            _lastArgPos = 0; _expectedType = typeof(global::LunyEditor.UnityEditor.LuaCameraProjectionCache);
            if (_arg0.TryRead<global::LunyEditor.UnityEditor.LuaCameraProjectionCache>(out var _p0_UnityEditor_CameraProjectionCache))
            {
                var _arg1 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::Luny.UnityEngine.LuaVector3);
                if (_arg1.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p1_UnityEngine_Vector3))
        ...
        private static readonly global::Lua.LuaFunction _LuaHandleUtility_DistanceToLine = new global::Lua.LuaFunction("DistanceToLine", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p0_UnityEngine_Vector3))
            {
                ...
                if (_arg1.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p1_UnityEngine_Vector3))
                {
                    if (_argCount == 2)
                    {
                        var p1 = _p0_UnityEngine_Vector3.Value;
                        var p2 = _p1_UnityEngine_Vector3.Value;
        ...
        private static readonly global::Lua.LuaFunction _LuaHandleUtility_GetPickingIncludeExcludeList = new global::Lua.LuaFunction("GetPickingIncludeExcludeList", (_context, _) =>
        {
            ...
            if (_argCount == 0)
            {
                ...
                var _lret0 = global::LunyEditor.UnityEditor.LuaPickingIncludeExcludeList.Bind(_ret0);
                var _retCount = _context.Return(_lret0);
                return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
            }
            var _arg0 = _lastArg = _argCount > 0 ? _context.GetArgument(0) : global::Lua.LuaValue.Nil;
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p0_UnityEngine_Vector3))
            {
                ...
                if (_arg1.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p1_UnityEngine_Vector3))
                {
                    ...
                    if (_arg2.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p2_UnityEngine_Vector3))
                    {
                        ...
                        {
                            var point = _p0_UnityEngine_Vector3.Value;
                            var linePoint = _p1_UnityEngine_Vector3.Value;
                            var lineDirection = _p2_UnityEngine_Vector3.Value;
        ...
        private static readonly global::Lua.LuaFunction _LuaHandleUtility_WorldToGUIPoint = new global::Lua.LuaFunction("WorldToGUIPoint", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p0_UnityEngine_Vector3))
            {
                if (_argCount == 1)
                {
                    var world = _p0_UnityEngine_Vector3.Value;
        ...
        private static readonly global::Lua.LuaFunction _LuaHandleUtility_WorldToGUIPointWithDepth = new global::Lua.LuaFunction("WorldToGUIPointWithDepth", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaCamera>(out var _p0_UnityEngine_Camera))
            {
                ...
                if (_arg1.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p1_UnityEngine_Vector3))
                {
                    ...
                    {
                        var camera = _p0_UnityEngine_Camera.Instance;
                        var world = _p1_UnityEngine_Vector3.Value;
        ...
        private static global::Lua.LuaTable CreateMetatable()
        {
            ...
            metatable[global::Lua.Runtime.Metamethods.Concat] = global::Luny.LuaMetatable.ConcatMetamethod;
            metatable[global::Lua.Runtime.Metamethods.ToString] = global::Luny.LuaMetatable.ToStringMetamethod;
            metatable[global::Lua.Runtime.Metamethods.Call] = _LuaHandleUtility_new;
            return metatable;
        }
        private static global::Lua.LuaTable s_Metatable;
        public global::Lua.LuaTable Metatable
