...
namespace Luny.UnityEngine
{
    public class LuaResourceRequest : global::Luny.UnityEngine.LuaAsyncOperation, global::Luny.ILuaObject<global::UnityEngine.ResourceRequest>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::UnityEngine.ResourceRequest> instances) =>
        ...
        {
            var _this = _context.GetArgument<LuaResourceRequest>(0);
        ...
        public override global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                case "asset": _value = _factory.Bind(Instance.asset); return true;
    ...
    public sealed class LuaResourceRequestType : global::Luny.ILuaStatic
    {
        public static global::Lua.LuaValue Bind() => new LuaResourceRequestType();
        private LuaResourceRequestType() {}
        public static implicit operator global::Lua.LuaValue(LuaResourceRequestType value) => new(value);
        public global::System.Type BindType => typeof(global::UnityEngine.ResourceRequest);
        ...
        private static readonly global::Lua.LuaFunction _LuaResourceRequest_new = new global::Lua.LuaFunction(".ctor", (_context, _) =>
        {
            ...
            if (_argCount == 1)
            {
                var _ret0 = new global::UnityEngine.ResourceRequest();
                var _factory = _context.GetObjectFactory();
        ...
        private static readonly global::Lua.LuaFunction __index = new(global::Lua.Runtime.Metamethods.Index, (_context, _) =>
        {
            var _this = _context.GetArgument<LuaResourceRequestType>(0);
            var _key = _context.GetArgument(1);
            var _factory = _context.GetObjectFactory();
            global::Lua.LuaValue _value = global::Lua.LuaValue.Nil;
            if (_key.Type == global::Lua.LuaValueType.Number && _key.TryRead<global::System.Int32>(out var _index) && _this.TryGetLuaValue(_index, out _value, _factory))
        ...
        private static global::Lua.LuaTable CreateMetatable()
        {
            ...
            metatable[global::Lua.Runtime.Metamethods.Concat] = global::Luny.LuaMetatable.ConcatMetamethod;
            metatable[global::Lua.Runtime.Metamethods.ToString] = global::Luny.LuaMetatable.ToStringMetamethod;
            metatable[global::Lua.Runtime.Metamethods.Call] = _LuaResourceRequest_new;
            return metatable;
        }
        private static global::Lua.LuaTable s_Metatable;
