...
{
	public sealed partial class LunyAssetRegistry
	{
		...
		private static LunyAssetRegistry CreateRegistryAsset()
		{
			...
			var path = $"{nameof(LunyAssetRegistry)}.asset";
			AssetDatabase.CreateAsset(registry, path);

			registry.ScanForAssets();
			return registry;
		}
