...
namespace Luny.UnityEngine
{
    public sealed class LuaWaitForSecondsRealtime : LuaCustomYieldInstruction, global::Luny.ILuaObject<global::UnityEngine.WaitForSecondsRealtime>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::UnityEngine.WaitForSecondsRealtime> instances) =>
        ...
        private static readonly global::Lua.LuaFunction _LuaWaitForSecondsRealtime_Reset = new global::Lua.LuaFunction("Reset", (_context, _) =>
        {
            global::Lua.LuaValue _lastArg = default;
            global::System.Int32 _lastArgPos = default;
            global::System.Type _expectedType = default;
            var _argCount = _context.ArgumentCount;
            var _this = _context.GetArgument<LuaWaitForSecondsRealtime>(0);
            if (_argCount == 1)
            {
        ...
        public override global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                case "Reset": _value = _LuaWaitForSecondsRealtime_Reset; return true;
                case "keepWaiting": _value = new global::Lua.LuaValue(Instance.keepWaiting); return true;
                case "waitTime": _value = new global::Lua.LuaValue(Instance.waitTime); return true;
        ...
        public override global::System.Boolean TrySetLuaValue(global::System.String _key, global::Lua.LuaValue _value)
        {
            switch (_key)
            {
                case "waitTime": Instance.waitTime = _value.Read<global::System.Single>();  return true;
                default: return base.TrySetLuaValue(_key, _value);
            }
        }
    }
    public sealed class LuaWaitForSecondsRealtimeType : global::Luny.ILuaStatic
    {
        public static global::Lua.LuaValue Bind() => new LuaWaitForSecondsRealtimeType();
        private LuaWaitForSecondsRealtimeType() {}
        public static implicit operator global::Lua.LuaValue(LuaWaitForSecondsRealtimeType value) => new(value);
        public global::System.Type BindType => typeof(global::UnityEngine.WaitForSecondsRealtime);
        private static global::Lua.LuaTable s_Metatable;
        ...
        private static global::Lua.LuaTable CreateMetatable()
        {
            ...
            metatable[global::Lua.Runtime.Metamethods.Concat] = global::Luny.LuaMetatable.ConcatMetamethod;
            metatable[global::Lua.Runtime.Metamethods.ToString] = global::Luny.LuaMetatable.ToStringMetamethod;
            metatable[global::Lua.Runtime.Metamethods.Call] = _LuaWaitForSecondsRealtime_new;
            return metatable;
        }
        ...
        private static readonly global::Lua.LuaFunction _LuaWaitForSecondsRealtime_new = new global::Lua.LuaFunction(".ctor", (_context, _) =>
        {
            global::Lua.LuaValue _lastArg = default;
            global::System.Int32 _lastArgPos = default;
            global::System.Type _expectedType = default;
            ...
            if (_arg0.TryRead<global::System.Single>(out var _p0_System_Single))
            {
                if (_argCount == 2)
                {
                    ...
                    var _ret0 = new global::UnityEngine.WaitForSecondsRealtime(time);
                    var _factory = _context.GetObjectFactory();
        ...
        private static readonly global::Lua.LuaFunction __index = new(global::Lua.Runtime.Metamethods.Index, (_context, _) =>
        {
            var _this = _context.GetArgument<LuaWaitForSecondsRealtimeType>(0);
            var _key = _context.GetArgument(1);
            var _factory = _context.GetObjectFactory();
            global::Lua.LuaValue _value = global::Lua.LuaValue.Nil;
            if (_key.Type == global::Lua.LuaValueType.Number && _key.TryRead<global::System.Int32>(out var _index) && _this.TryGetLuaValue(_index, out _value, _factory))
