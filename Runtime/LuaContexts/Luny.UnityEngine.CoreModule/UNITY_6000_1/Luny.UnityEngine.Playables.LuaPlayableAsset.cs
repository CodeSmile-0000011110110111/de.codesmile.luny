...
namespace Luny.UnityEngine.Playables
{
    public sealed class LuaPlayableAsset : LuaScriptableObject, global::Luny.ILuaObject<global::UnityEngine.Playables.PlayableAsset>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::UnityEngine.Playables.PlayableAsset> instances) =>
        ...
        private static readonly global::Lua.LuaFunction _LuaPlayableAsset_CreatePlayable = new global::Lua.LuaFunction("CreatePlayable", (_context, _) =>
        {
            global::Lua.LuaValue _lastArg = default;
            global::System.Int32 _lastArgPos = default;
            global::System.Type _expectedType = default;
            var _argCount = _context.ArgumentCount;
            var _this = _context.GetArgument<LuaPlayableAsset>(0);
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.Playables.LuaPlayableGraph>(out var _p0_UnityEngine_Playables_PlayableGraph))
            {
                ...
                if (_arg1.TryRead<global::Luny.UnityEngine.LuaGameObject>(out var _p1_UnityEngine_GameObject))
                {
                    if (_argCount == 3)
                    {
                        ...
                        var owner = _p1_UnityEngine_GameObject.Instance;
                        var _ret0 = _this.Instance.CreatePlayable(graph, owner);
            ...
            throw new global::Lua.LuaRuntimeException(_context.Thread, $"{"CreatePlayable"}: invalid argument #{_lastArgPos}: {_lastArg} ({_lastArg.Type}), expected: {_expectedType.FullName}", 2);
        });
        ...
        public override global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                case "CreatePlayable": _value = _LuaPlayableAsset_CreatePlayable; return true;
    ...
    public sealed class LuaPlayableAssetType : global::Luny.ILuaStatic
    {
        public static global::Lua.LuaValue Bind() => new LuaPlayableAssetType();
        private LuaPlayableAssetType() {}
        public static implicit operator global::Lua.LuaValue(LuaPlayableAssetType value) => new(value);
        public global::System.Type BindType => typeof(global::UnityEngine.Playables.PlayableAsset);
        private static global::Lua.LuaTable s_Metatable;
        ...
        private static readonly global::Lua.LuaFunction __index = new(global::Lua.Runtime.Metamethods.Index, (_context, _) =>
        {
            var _this = _context.GetArgument<LuaPlayableAssetType>(0);
            var _key = _context.GetArgument(1);
            var _factory = _context.GetObjectFactory();
            global::Lua.LuaValue _value = global::Lua.LuaValue.Nil;
            if (_key.Type == global::Lua.LuaValueType.Number && _key.TryRead<global::System.Int32>(out var _index) && _this.TryGetLuaValue(_index, out _value, _factory))
