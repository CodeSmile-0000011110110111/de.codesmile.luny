...
namespace Luny.UnityEngine
{
    ...
    public sealed class LuaResourcesType : global::Luny.ILuaStatic
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaResources_EntityIdIsValid = new global::Lua.LuaFunction("EntityIdIsValid", (_context, _) =>
        {
            global::Lua.LuaValue _lastArg = default;
            global::System.Int32 _lastArgPos = default;
            global::System.Type _expectedType = default;
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaEntityId>(out var _p0_UnityEngine_EntityId))
            {
                if (_argCount == 1)
                {
                    ...
                    var _ret0 = global::UnityEngine.Resources.EntityIdIsValid(entityId);
                    var _lret0 = new global::Lua.LuaValue(_ret0);
                    var _retCount = _context.Return(_lret0);
                    return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                }
            }
            throw new global::Lua.LuaRuntimeException(_context.Thread, $"{"EntityIdIsValid"}: invalid argument #{_lastArgPos}: {_lastArg} ({_lastArg.Type}), expected: {_expectedType.FullName}", 2);
        });
        private static readonly global::Lua.LuaFunction _LuaResources_EntityIdToObject = new global::Lua.LuaFunction("EntityIdToObject", (_context, _) =>
        {
            global::Lua.LuaValue _lastArg = default;
            global::System.Int32 _lastArgPos = default;
            global::System.Type _expectedType = default;
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaEntityId>(out var _p0_UnityEngine_EntityId))
            {
                ...
                {
                    var entityId = _p0_UnityEngine_EntityId.Value;
                    var _ret0 = global::UnityEngine.Resources.EntityIdToObject(entityId);
                    var _factory = _context.GetObjectFactory();
                    var _lret0 = _factory.Bind(_ret0);
                    var _retCount = _context.Return(_lret0);
                    return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
            ...
            throw new global::Lua.LuaRuntimeException(_context.Thread, $"{"EntityIdToObject"}: invalid argument #{_lastArgPos}: {_lastArg} ({_lastArg.Type}), expected: {_expectedType.FullName}", 2);
        });
        ...
        public global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                case "new": _value = _LuaResources_new; return true;
                case "EntityIdIsValid": _value = _LuaResources_EntityIdIsValid; return true;
                case "EntityIdToObject": _value = _LuaResources_EntityIdToObject; return true;
