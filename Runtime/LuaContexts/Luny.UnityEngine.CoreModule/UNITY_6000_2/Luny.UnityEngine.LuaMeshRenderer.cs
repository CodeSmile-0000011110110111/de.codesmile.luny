...
namespace Luny.UnityEngine
{
    public sealed class LuaMeshRenderer : LuaRenderer, global::Luny.ILuaObject<global::UnityEngine.MeshRenderer>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::UnityEngine.MeshRenderer> instances) =>
        ...
        {
            var _this = _context.GetArgument<LuaMeshRenderer>(0);
        ...
        public override global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                case "additionalVertexStreams": _value = _factory.Bind(Instance.additionalVertexStreams); return true;
                case "enlightenVertexStream": _value = _factory.Bind(Instance.enlightenVertexStream); return true;
                case "globalIlluminationMeshLod": _value = new global::Lua.LuaValue(Instance.globalIlluminationMeshLod); return true;
                case "subMeshStartIndex": _value = new global::Lua.LuaValue(Instance.subMeshStartIndex); return true;
        ...
        public override global::System.Boolean TrySetLuaValue(global::System.String _key, global::Lua.LuaValue _value)
        {
            switch (_key)
            {
                case "additionalVertexStreams": Instance.additionalVertexStreams = _value.Read<global::Luny.UnityEngine.LuaMesh>().Instance;  return true;
                case "enlightenVertexStream": Instance.enlightenVertexStream = _value.Read<global::Luny.UnityEngine.LuaMesh>().Instance;  return true;
                case "globalIlluminationMeshLod": Instance.globalIlluminationMeshLod = _value.Read<global::System.UInt16>();  return true;
                default: return base.TrySetLuaValue(_key, _value);
            }
        }
    }
    public sealed class LuaMeshRendererType : global::Luny.ILuaStatic
    {
        public static global::Lua.LuaValue Bind() => new LuaMeshRendererType();
        private LuaMeshRendererType() {}
        public static implicit operator global::Lua.LuaValue(LuaMeshRendererType value) => new(value);
        public global::System.Type BindType => typeof(global::UnityEngine.MeshRenderer);
        private static global::Lua.LuaTable s_Metatable;
        ...
        private static global::Lua.LuaTable CreateMetatable()
        {
            ...
            metatable[global::Lua.Runtime.Metamethods.Concat] = global::Luny.LuaMetatable.ConcatMetamethod;
            metatable[global::Lua.Runtime.Metamethods.ToString] = global::Luny.LuaMetatable.ToStringMetamethod;
            metatable[global::Lua.Runtime.Metamethods.Call] = _LuaMeshRenderer_new;
            return metatable;
        }
        ...
        private static readonly global::Lua.LuaFunction _LuaMeshRenderer_new = new global::Lua.LuaFunction(".ctor", (_context, _) =>
        {
            ...
            if (_argCount == 1)
            {
                var _ret0 = new global::UnityEngine.MeshRenderer();
                var _factory = _context.GetObjectFactory();
        ...
        private static readonly global::Lua.LuaFunction __index = new(global::Lua.Runtime.Metamethods.Index, (_context, _) =>
        {
            var _this = _context.GetArgument<LuaMeshRendererType>(0);
            var _key = _context.GetArgument(1);
            var _factory = _context.GetObjectFactory();
            global::Lua.LuaValue _value = global::Lua.LuaValue.Nil;
            if (_key.Type == global::Lua.LuaValueType.Number && _key.TryRead<global::System.Int32>(out var _index) && _this.TryGetLuaValue(_index, out _value, _factory))
