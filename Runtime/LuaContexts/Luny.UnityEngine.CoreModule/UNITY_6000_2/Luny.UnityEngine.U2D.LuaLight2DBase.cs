...
namespace Luny.UnityEngine.U2D
{
    public sealed class LuaLight2DBase : LuaMonoBehaviour, global::Luny.ILuaObject<global::UnityEngine.U2D.Light2DBase>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::UnityEngine.U2D.Light2DBase> instances) =>
        ...
        {
            var _this = _context.GetArgument<LuaLight2DBase>(0);
    ...
    public sealed class LuaLight2DBaseType : global::Luny.ILuaStatic
    {
        public static global::Lua.LuaValue Bind() => new LuaLight2DBaseType();
        private LuaLight2DBaseType() {}
        public static implicit operator global::Lua.LuaValue(LuaLight2DBaseType value) => new(value);
        public global::System.Type BindType => typeof(global::UnityEngine.U2D.Light2DBase);
        private static global::Lua.LuaTable s_Metatable;
        ...
        private static readonly global::Lua.LuaFunction __index = new(global::Lua.Runtime.Metamethods.Index, (_context, _) =>
        {
            var _this = _context.GetArgument<LuaLight2DBaseType>(0);
            var _key = _context.GetArgument(1);
            var _factory = _context.GetObjectFactory();
            global::Lua.LuaValue _value = global::Lua.LuaValue.Nil;
            if (_key.Type == global::Lua.LuaValueType.Number && _key.TryRead<global::System.Int32>(out var _index) && _this.TryGetLuaValue(_index, out _value, _factory))
