...
namespace Luny.UnityEngine
{
    public sealed class LuaProjector : LuaBehaviour, global::Luny.ILuaObject<global::UnityEngine.Projector>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::UnityEngine.Projector> instances) =>
            new global::Luny.LuaList<global::UnityEngine.Projector>(instances);
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::System.Object> instances) =>
            new global::Luny.LuaList<global::UnityEngine.Projector>(instances);
        private LuaProjector(global::UnityEngine.Projector instance) : base(instance) {}
        public static implicit operator global::Lua.LuaValue(LuaProjector value) => new(value);
        public new global::UnityEngine.Projector Instance => (global::UnityEngine.Projector)m_Instance;
        public new global::System.Type BindType => typeof(global::UnityEngine.Projector);
        ...
        {
            var _this = _context.GetArgument<LuaProjector>(0);
        ...
        public override global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                case "aspectRatio": _value = new global::Lua.LuaValue(Instance.aspectRatio); return true;
                ...
                case "ignoreLayers": _value = new global::Lua.LuaValue(Instance.ignoreLayers); return true;
        ...
        public override global::System.Boolean TrySetLuaValue(global::System.String _key, global::Lua.LuaValue _value)
        {
            switch (_key)
            {
                case "aspectRatio": Instance.aspectRatio = _value.Read<global::System.Single>();  return true;
                ...
                case "ignoreLayers": Instance.ignoreLayers = _value.Read<global::System.Int32>();  return true;
    ...
    public sealed class LuaProjectorType : global::Luny.ILuaStatic
    {
        public static global::Lua.LuaValue Bind() => new LuaProjectorType();
        private LuaProjectorType() {}
        public static implicit operator global::Lua.LuaValue(LuaProjectorType value) => new(value);
        public global::System.Type BindType => typeof(global::UnityEngine.Projector);
        private static global::Lua.LuaTable s_Metatable;
        ...
        private static global::Lua.LuaTable CreateMetatable()
        {
            ...
            metatable[global::Lua.Runtime.Metamethods.Concat] = global::Luny.LuaMetatable.ConcatMetamethod;
            metatable[global::Lua.Runtime.Metamethods.ToString] = global::Luny.LuaMetatable.ToStringMetamethod;
            metatable[global::Lua.Runtime.Metamethods.Call] = _LuaProjector_new;
            return metatable;
        }
        ...
        private static readonly global::Lua.LuaFunction _LuaProjector_new = new global::Lua.LuaFunction(".ctor", (_context, _) =>
        {
            ...
            if (_argCount == 1)
            {
                var _ret0 = new global::UnityEngine.Projector();
                var _factory = _context.GetObjectFactory();
        ...
        private static readonly global::Lua.LuaFunction __index = new(global::Lua.Runtime.Metamethods.Index, (_context, _) =>
        {
            var _this = _context.GetArgument<LuaProjectorType>(0);
            var _key = _context.GetArgument(1);
            var _factory = _context.GetObjectFactory();
            global::Lua.LuaValue _value = global::Lua.LuaValue.Nil;
            if (_key.Type == global::Lua.LuaValueType.Number && _key.TryRead<global::System.Int32>(out var _index) && _this.TryGetLuaValue(_index, out _value, _factory))
