...
namespace Luny.UnityEngine
{
    public sealed class LuaFlareLayer : LuaBehaviour, global::Luny.ILuaObject<global::UnityEngine.FlareLayer>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::UnityEngine.FlareLayer> instances) =>
        ...
        {
            var _this = _context.GetArgument<LuaFlareLayer>(0);
    ...
    public sealed class LuaFlareLayerType : global::Luny.ILuaStatic
    {
        public static global::Lua.LuaValue Bind() => new LuaFlareLayerType();
        private LuaFlareLayerType() {}
        public static implicit operator global::Lua.LuaValue(LuaFlareLayerType value) => new(value);
        public global::System.Type BindType => typeof(global::UnityEngine.FlareLayer);
        private static global::Lua.LuaTable s_Metatable;
        ...
        private static readonly global::Lua.LuaFunction __index = new(global::Lua.Runtime.Metamethods.Index, (_context, _) =>
        {
            var _this = _context.GetArgument<LuaFlareLayerType>(0);
            var _key = _context.GetArgument(1);
            var _factory = _context.GetObjectFactory();
            global::Lua.LuaValue _value = global::Lua.LuaValue.Nil;
            if (_key.Type == global::Lua.LuaValueType.Number && _key.TryRead<global::System.Int32>(out var _index) && _this.TryGetLuaValue(_index, out _value, _factory))
