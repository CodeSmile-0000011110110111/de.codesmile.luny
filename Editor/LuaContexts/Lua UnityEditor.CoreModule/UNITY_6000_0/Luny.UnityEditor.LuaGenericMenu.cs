...
namespace Luny.UnityEditor
{
    public sealed class LuaGenericMenu : global::Luny.ILuaObject<global::UnityEditor.GenericMenu>
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaGenericMenu_AddItem = new global::Lua.LuaFunction("AddItem", (_context, _) =>
        {
            global::Lua.LuaValue _lastArg = default;
            global::System.Int32 _lastArgPos = default;
            global::System.Type _expectedType = default;
            ...
            if (_arg0.TryRead<global::UnityEngine.GUIContent>(out var _p0_UnityEngine_GUIContent))
            {
                ...
                if (_arg1.TryRead<global::System.Boolean>(out var _p1_System_Boolean))
                {
                    ...
                    _lastArgPos = 2; _expectedType = typeof(global::UnityEditor.GenericMenu.MenuFunction);
                    if (_arg2.TryRead<global::UnityEditor.GenericMenu.MenuFunction>(out var _p2_UnityEditor_GenericMenu_MenuFunction))
                    {
                        if (_argCount == 4)
                        {
                            var content = _p0_UnityEngine_GUIContent;
                            var on = _p1_System_Boolean;
                            var func = _p2_UnityEditor_GenericMenu_MenuFunction;
                            _this.Instance.AddItem(content, on, func);
                            var _retCount = _context.Return();
                            return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                        }
                    }
                    ...
                    if (_arg2.TryRead<global::UnityEditor.GenericMenu.MenuFunction2>(out var _p2_UnityEditor_GenericMenu_MenuFunction2))
                    {
                        ...
                        if (_arg3.TryRead<global::System.Object>(out var _p3_System_Object))
                        {
                            if (_argCount == 5)
                            {
                                var content = _p0_UnityEngine_GUIContent;
                                var on = _p1_System_Boolean;
                                var func = _p2_UnityEditor_GenericMenu_MenuFunction2;
                                var userData = _p3_System_Object;
                                _this.Instance.AddItem(content, on, func, userData);
                                var _retCount = _context.Return();
                                return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                            }
                        }
            ...
            throw new global::Lua.LuaRuntimeException(_context.Thread, $"{"AddItem"}: invalid argument #{_lastArgPos}: {_lastArg} ({_lastArg.Type}), expected: {_expectedType.FullName}", 2);
        });
        ...
        public global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                ...
                case "AddItem": _value = _LuaGenericMenu_AddItem; return true;
    ...
    public sealed class LuaGenericMenuType : global::Luny.ILuaStatic
    {
        ...
        public global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                case "new": _value = _LuaGenericMenu_new; return true;
                default: _value = global::Lua.LuaValue.Nil; return false;
            }
        }
        public global::System.Boolean TrySetLuaValue(global::System.Int32 _key, global::Lua.LuaValue _value)
