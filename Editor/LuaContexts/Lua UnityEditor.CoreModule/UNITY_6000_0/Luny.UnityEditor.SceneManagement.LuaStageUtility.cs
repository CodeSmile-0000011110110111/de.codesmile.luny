    ...
    public sealed class LuaStageUtilityType : global::Luny.ILuaStatic
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaStageUtility_GetCurrentStageHandle = new global::Lua.LuaFunction("GetCurrentStageHandle", (_context, _) =>
        {
            ...
            if (_argCount == 0)
            {
                ...
                var _lret0 = global::Luny.UnityEditor.SceneManagement.LuaStageHandle.Bind(_ret0);
                var _retCount = _context.Return(_lret0);
                return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
            }
        ...
        private static readonly global::Lua.LuaFunction _LuaStageUtility_GoToStage = new global::Lua.LuaFunction("GoToStage", (_context, _) =>
        {
            ...
            var _argCount = _context.ArgumentCount;
            var _arg0 = _lastArg = _argCount > 0 ? _context.GetArgument(0) : global::Lua.LuaValue.Nil;
            _lastArgPos = 0; _expectedType = typeof(global::Luny.UnityEditor.SceneManagement.LuaStage);
            if (_arg0.TryRead<global::Luny.UnityEditor.SceneManagement.LuaStage>(out var _p0_UnityEditor_SceneManagement_Stage))
            {
        ...
        private static readonly global::Lua.LuaFunction _LuaStageUtility_IsGameObjectRenderedByCamera = new global::Lua.LuaFunction("IsGameObjectRenderedByCamera", (_context, _) =>
        {
            ...
            {
                var _arg1 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::UnityEngine.Camera);
                if (_arg1.TryRead<global::UnityEngine.Camera>(out var _p1_UnityEngine_Camera))
                {
                    if (_argCount == 2)
                    {
                        var gameObject = _p0_UnityEngine_GameObject;
                        var camera = _p1_UnityEngine_Camera;
