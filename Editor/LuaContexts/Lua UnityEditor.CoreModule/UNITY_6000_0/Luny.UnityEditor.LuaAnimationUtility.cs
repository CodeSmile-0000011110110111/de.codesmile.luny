...
{
    public sealed class LuaAnimationUtility : global::Luny.ILuaObject<global::UnityEditor.AnimationUtility>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::System.Object> instances) =>
            new global::Luny.LuaList<global::UnityEditor.AnimationUtility>(instances);
        private LuaAnimationUtility(global::UnityEditor.AnimationUtility instance) => m_Instance = instance;
        public static implicit operator global::Lua.LuaValue(LuaAnimationUtility value) => new(value);
        private global::UnityEditor.AnimationUtility m_Instance;
    ...
    public sealed class LuaAnimationUtilityType : global::Luny.ILuaStatic
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaAnimationUtility_CalculateTransformPath = new global::Lua.LuaFunction("CalculateTransformPath", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::UnityEngine.Transform>(out var _p0_UnityEngine_Transform))
            {
                ...
                if (_arg1.TryRead<global::UnityEngine.Transform>(out var _p1_UnityEngine_Transform))
                {
                    if (_argCount == 2)
                    {
                        var targetTransform = _p0_UnityEngine_Transform;
                        var root = _p1_UnityEngine_Transform;
        ...
        private static readonly global::Lua.LuaFunction _LuaAnimationUtility_ConstrainToPolynomialCurve = new global::Lua.LuaFunction("ConstrainToPolynomialCurve", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::UnityEngine.AnimationCurve>(out var _p0_UnityEngine_AnimationCurve))
            {
                if (_argCount == 1)
                {
                    var curve = _p0_UnityEngine_AnimationCurve;
        ...
        private static readonly global::Lua.LuaFunction _LuaAnimationUtility_GetAnimatableBindings = new global::Lua.LuaFunction("GetAnimatableBindings", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::UnityEngine.GameObject>(out var _p0_UnityEngine_GameObject))
            {
                ...
                if (_arg1.TryRead<global::UnityEngine.GameObject>(out var _p1_UnityEngine_GameObject))
                {
                    if (_argCount == 2)
                    {
                        var targetObject = _p0_UnityEngine_GameObject;
                        var root = _p1_UnityEngine_GameObject;
                ...
                if (_arg1.TryRead<global::Luny.UnityEditor.LuaEditorCurveBinding>(out var _p1_UnityEditor_EditorCurveBinding))
                {
                    ...
                    if (_arg2.TryRead<global::UnityEngine.AnimationCurve>(out var _p2_UnityEngine_AnimationCurve))
                    {
                        if (_argCount == 3)
                        {
                            var clip = _p0_UnityEngine_AnimationClip;
                            var binding = _p1_UnityEditor_EditorCurveBinding.Value;
                            var curve = _p2_UnityEngine_AnimationCurve;
        ...
        public global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                case "new": _value = _LuaAnimationUtility_new; return true;
