...
{
    public sealed class LuaPreviewRenderUtility : global::Luny.ILuaObject<global::UnityEditor.PreviewRenderUtility>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::System.Object> instances) =>
            new global::Luny.LuaList<global::UnityEditor.PreviewRenderUtility>(instances);
        private LuaPreviewRenderUtility(global::UnityEditor.PreviewRenderUtility instance) => m_Instance = instance;
        public static implicit operator global::Lua.LuaValue(LuaPreviewRenderUtility value) => new(value);
        private global::UnityEditor.PreviewRenderUtility m_Instance;
        ...
        private static readonly global::Lua.LuaFunction _LuaPreviewRenderUtility_DrawMesh = new global::Lua.LuaFunction("DrawMesh", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::UnityEngine.Mesh>(out var _p0_UnityEngine_Mesh))
            {
                var _arg1 = _lastArg = _argCount > 2 ? _context.GetArgument(2) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::UnityEngine.Matrix4x4);
                if (_arg1.TryRead<global::UnityEngine.Matrix4x4>(out var _p1_UnityEngine_Matrix4x4))
                {
                    ...
                    if (_arg2.TryRead<global::UnityEngine.Material>(out var _p2_UnityEngine_Material))
                    {
                        ...
                        if (_arg3.TryRead<global::System.Int32>(out var _p3_System_Int32))
                        {
                            if (_argCount == 5)
                            {
                                var mesh = _p0_UnityEngine_Mesh;
                                var matrix = _p1_UnityEngine_Matrix4x4;
                            ...
                            _lastArgPos = 4; _expectedType = typeof(global::UnityEngine.MaterialPropertyBlock);
                            if (_arg4.TryRead<global::UnityEngine.MaterialPropertyBlock>(out var _p4_UnityEngine_MaterialPropertyBlock))
                            {
                                if (_argCount == 6)
                                {
                                    var mesh = _p0_UnityEngine_Mesh;
                                    ...
                                    var mat = _p2_UnityEngine_Material;
                                    var subMeshIndex = _p3_System_Int32;
                                    var customProperties = _p4_UnityEngine_MaterialPropertyBlock;
                                ...
                                _lastArgPos = 5; _expectedType = typeof(global::UnityEngine.Transform);
                                if (_arg5.TryRead<global::UnityEngine.Transform>(out var _p5_UnityEngine_Transform))
                                {
                                    ...
                                    if (_arg6.TryRead<global::System.Boolean>(out var _p6_System_Boolean))
                                    {
                                        ...
                                        {
                                            var mesh = _p0_UnityEngine_Mesh;
                                            var m = _p1_UnityEngine_Matrix4x4;
                                            var mat = _p2_UnityEngine_Material;
                                            var subMeshIndex = _p3_System_Int32;
                                            var customProperties = _p4_UnityEngine_MaterialPropertyBlock;
                                            var probeAnchor = _p5_UnityEngine_Transform;
                ...
                if (_arg1.TryRead<global::UnityEngine.Vector3>(out var _p1_UnityEngine_Vector3))
                {
                    ...
                    {
                        var _arg3 = _lastArg = _argCount > 4 ? _context.GetArgument(4) : global::Lua.LuaValue.Nil;
                        _lastArgPos = 3; _expectedType = typeof(global::UnityEngine.Material);
                        if (_arg3.TryRead<global::UnityEngine.Material>(out var _p3_UnityEngine_Material))
                        {
                            var _arg4 = _lastArg = _argCount > 5 ? _context.GetArgument(5) : global::Lua.LuaValue.Nil;
                            ...
                            if (_arg4.TryRead<global::System.Int32>(out var _p4_System_Int32))
                            {
                                ...
                                {
                                    var mesh = _p0_UnityEngine_Mesh;
                                    var pos = _p1_UnityEngine_Vector3;
                                    var rot = _p2_UnityEngine_Quaternion;
                                    var mat = _p3_UnityEngine_Material;
                                ...
                                var _arg5 = _lastArg = _argCount > 6 ? _context.GetArgument(6) : global::Lua.LuaValue.Nil;
                                _lastArgPos = 5; _expectedType = typeof(global::UnityEngine.MaterialPropertyBlock);
                                if (_arg5.TryRead<global::UnityEngine.MaterialPropertyBlock>(out var _p5_UnityEngine_MaterialPropertyBlock))
                                {
                                    if (_argCount == 7)
                                    {
                                        var mesh = _p0_UnityEngine_Mesh;
                                        ...
                                        var mat = _p3_UnityEngine_Material;
                                        var subMeshIndex = _p4_System_Int32;
                                        var customProperties = _p5_UnityEngine_MaterialPropertyBlock;
                                        _this.Instance.DrawMesh(mesh, pos, rot, mat, subMeshIndex, customProperties);
                                        var _retCount = _context.Return();
                                        return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                                    }
                                    var _arg6 = _lastArg = _argCount > 7 ? _context.GetArgument(7) : global::Lua.LuaValue.Nil;
                                    _lastArgPos = 6; _expectedType = typeof(global::UnityEngine.Transform);
                                    if (_arg6.TryRead<global::UnityEngine.Transform>(out var _p6_UnityEngine_Transform))
                                    {
                                        if (_argCount == 8)
                                        {
                                            var mesh = _p0_UnityEngine_Mesh;
                                            ...
                                            var subMeshIndex = _p4_System_Int32;
                                            var customProperties = _p5_UnityEngine_MaterialPropertyBlock;
                                            var probeAnchor = _p6_UnityEngine_Transform;
                    ...
                    if (_arg2.TryRead<global::UnityEngine.Vector3>(out var _p2_UnityEngine_Vector3))
                    {
                        ...
                        {
                            var _arg4 = _lastArg = _argCount > 5 ? _context.GetArgument(5) : global::Lua.LuaValue.Nil;
                            _lastArgPos = 4; _expectedType = typeof(global::UnityEngine.Material);
                            if (_arg4.TryRead<global::UnityEngine.Material>(out var _p4_UnityEngine_Material))
                            {
                                var _arg5 = _lastArg = _argCount > 6 ? _context.GetArgument(6) : global::Lua.LuaValue.Nil;
                                ...
                                {
                                    var _arg6 = _lastArg = _argCount > 7 ? _context.GetArgument(7) : global::Lua.LuaValue.Nil;
                                    _lastArgPos = 6; _expectedType = typeof(global::UnityEngine.MaterialPropertyBlock);
                                    if (_arg6.TryRead<global::UnityEngine.MaterialPropertyBlock>(out var _p6_UnityEngine_MaterialPropertyBlock))
                                    {
                                        var _arg7 = _lastArg = _argCount > 8 ? _context.GetArgument(8) : global::Lua.LuaValue.Nil;
                                        _lastArgPos = 7; _expectedType = typeof(global::UnityEngine.Transform);
                                        if (_arg7.TryRead<global::UnityEngine.Transform>(out var _p7_UnityEngine_Transform))
                                        {
                                            ...
                                            if (_arg8.TryRead<global::System.Boolean>(out var _p8_System_Boolean))
                                            {
                                                if (_argCount == 10)
                                                {
                                                    var mesh = _p0_UnityEngine_Mesh;
                                                    var pos = _p1_UnityEngine_Vector3;
                                                    var scale = _p2_UnityEngine_Vector3;
                                                    var rot = _p3_UnityEngine_Quaternion;
                                                    var mat = _p4_UnityEngine_Material;
                                                    var subMeshIndex = _p5_System_Int32;
                                                    var customProperties = _p6_UnityEngine_MaterialPropertyBlock;
                                                    var probeAnchor = _p7_UnityEngine_Transform;
        ...
        private static readonly global::Lua.LuaFunction _LuaPreviewRenderUtility_InstantiatePrefabInScene = new global::Lua.LuaFunction("InstantiatePrefabInScene", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::UnityEngine.GameObject>(out var _p0_UnityEngine_GameObject))
            {
                if (_argCount == 2)
                {
                    var prefab = _p0_UnityEngine_GameObject;
        ...
        private static readonly global::Lua.LuaFunction _LuaPreviewRenderUtility_RenderMesh = new global::Lua.LuaFunction("RenderMesh", (_context, _) =>
        {
            global::Lua.LuaValue _lastArg = default;
            global::System.Int32 _lastArgPos = default;
            global::System.Type _expectedType = default;
                ...
                if (_arg1.TryRead<global::UnityEngine.Matrix4x4>(out var _p1_UnityEngine_Matrix4x4))
                {
                    ...
                    if (_arg2.TryRead<global::UnityEngine.Material>(out var _p2_UnityEngine_Material))
                    {
                        ...
                        if (_arg3.TryRead<global::System.Int32>(out var _p3_System_Int32))
                        {
                            ...
                            {
                                var mesh = _p0_UnityEngine_Mesh;
                                var matrix4X4 = _p1_UnityEngine_Matrix4x4;
                                var material = _p2_UnityEngine_Material;
                                var submeshIndex = _p3_System_Int32;
                                _this.Instance.RenderMesh(mesh, matrix4X4, material, submeshIndex);
                                var _retCount = _context.Return();
                                return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                            }
                            var _arg4 = _lastArg = _argCount > 5 ? _context.GetArgument(5) : global::Lua.LuaValue.Nil;
                            _lastArgPos = 4; _expectedType = typeof(global::UnityEngine.MaterialPropertyBlock);
                            var _p4_UnityEngine_MaterialPropertyBlock = _arg4.ReadValue<global::UnityEngine.MaterialPropertyBlock>(default);
                            {
                                if (_argCount == 6)
                                {
                                    var mesh = _p0_UnityEngine_Mesh;
                                    ...
                                    var material = _p2_UnityEngine_Material;
                                    var submeshIndex = _p3_System_Int32;
                                    var materialProp = _p4_UnityEngine_MaterialPropertyBlock;
                                    _this.Instance.RenderMesh(mesh, matrix4X4, material, submeshIndex, materialProp);
                                    var _retCount = _context.Return();
                                    return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                                }
                                var _arg5 = _lastArg = _argCount > 6 ? _context.GetArgument(6) : global::Lua.LuaValue.Nil;
                                ...
                                var _p5_System_Int32 = _arg5.ReadValue<global::System.Int32>((global::System.Int32)(-1));
                                {
                                    if (_argCount == 7)
                                    {
                                        ...
                                        var submeshIndex = _p3_System_Int32;
                                        var materialProp = _p4_UnityEngine_MaterialPropertyBlock;
                                        var meshLodIndex = _p5_System_Int32;
                                        _this.Instance.RenderMesh(mesh, matrix4X4, material, submeshIndex, materialProp, meshLodIndex);
                                        var _retCount = _context.Return();
                                        return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                                    }
                                }
            ...
            throw new global::Lua.LuaRuntimeException(_context.Thread, $"{"RenderMesh"}: invalid argument #{_lastArgPos}: {_lastArg} ({_lastArg.Type}), expected: {_expectedType.FullName}", 2);
        });
        ...
        public global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                ...
                case "RenderMesh": _value = _LuaPreviewRenderUtility_RenderMesh; return true;
                case "ambientColor": _value = _factory.Bind(Instance.ambientColor); return true;
        ...
        public global::System.Boolean TrySetLuaValue(global::System.String _key, global::Lua.LuaValue _value)
        {
            switch (_key)
            {
                case "ambientColor": Instance.ambientColor = _value.Read<global::UnityEngine.Color>();  return true;
    ...
    public sealed class LuaPreviewRenderUtilityType : global::Luny.ILuaStatic
    {
        ...
        public global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                case "new": _value = _LuaPreviewRenderUtility_new; return true;
                default: _value = global::Lua.LuaValue.Nil; return false;
            }
        }
        public global::System.Boolean TrySetLuaValue(global::System.Int32 _key, global::Lua.LuaValue _value)
