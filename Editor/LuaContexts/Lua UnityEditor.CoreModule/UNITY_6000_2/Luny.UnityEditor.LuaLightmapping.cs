...
namespace Luny.UnityEditor
{
    public sealed class LuaLightmappingType : global::Luny.ILuaStatic
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaLightmapping_BakeReflectionProbe = new global::Lua.LuaFunction("BakeReflectionProbe", (_context, _) =>
        {
            ...
            var _argCount = _context.ArgumentCount;
            var _arg0 = _lastArg = _argCount > 0 ? _context.GetArgument(0) : global::Lua.LuaValue.Nil;
            _lastArgPos = 0; _expectedType = typeof(global::UnityEngine.ReflectionProbe);
            if (_arg0.TryRead<global::UnityEngine.ReflectionProbe>(out var _p0_UnityEngine_ReflectionProbe))
            {
                ...
                if (_arg1.TryRead<global::System.String>(out var _p1_System_String))
                {
                    if (_argCount == 2)
                    {
                        var probe = _p0_UnityEngine_ReflectionProbe;
        ...
        private static readonly global::Lua.LuaFunction _LuaLightmapping_SetLightingDataAssetForScene = new global::Lua.LuaFunction("SetLightingDataAssetForScene", (_context, _) =>
        {
            ...
            {
                var _arg1 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::Luny.UnityEditor.LuaLightingDataAsset);
                if (_arg1.TryRead<global::Luny.UnityEditor.LuaLightingDataAsset>(out var _p1_UnityEditor_LightingDataAsset))
                {
                    if (_argCount == 2)
                    {
                        var scene = _p0_UnityEngine_SceneManagement_Scene;
        ...
        public global::System.Boolean TrySetLuaValue(global::System.String _key, global::Lua.LuaValue _value)
        {
            switch (_key)
            {
                ...
                case "lightingDataAsset": global::UnityEditor.Lightmapping.lightingDataAsset = _value.Read<global::Luny.UnityEditor.LuaLightingDataAsset>().Instance;  return true;
