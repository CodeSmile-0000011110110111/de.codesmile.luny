    ...
    public sealed class LuaContentBuildInterfaceType : global::Luny.ILuaStatic
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaContentBuildInterface_ArchiveAndCompress = new global::Lua.LuaFunction("ArchiveAndCompress", (_context, _) =>
        {
            ...
            if (_arg0.TryReadArray<global::UnityEditor.Build.Content.ResourceFile>(out var _p0_UnityEditor_Build_Content_ResourceFileArray))
            {
                ...
                if (_arg1.TryRead<global::System.String>(out var _p1_System_String))
                {
                    ...
                    _lastArgPos = 2; _expectedType = typeof(global::UnityEngine.BuildCompression);
                    if (_arg2.TryRead<global::UnityEngine.BuildCompression>(out var _p2_UnityEngine_BuildCompression))
                    {
                        if (_argCount == 3)
                        {
                            var resourceFiles = _p0_UnityEditor_Build_Content_ResourceFileArray;
                            var outputBundlePath = _p1_System_String;
                            var compression = _p2_UnityEngine_BuildCompression;
        ...
        private static readonly global::Lua.LuaFunction _LuaContentBuildInterface_CalculateBuildUsageTags = new global::Lua.LuaFunction("CalculateBuildUsageTags", (_context, _) =>
        {
            ...
            if (_arg0.TryReadArray<global::UnityEditor.Build.Content.ObjectIdentifier>(out var _p0_UnityEditor_Build_Content_ObjectIdentifierArray))
            {
                ...
                {
                    var _arg2 = _lastArg = _argCount > 2 ? _context.GetArgument(2) : global::Lua.LuaValue.Nil;
                    _lastArgPos = 2; _expectedType = typeof(global::Luny.UnityEditor.Build.Content.LuaBuildUsageTagGlobal);
                    if (_arg2.TryRead<global::Luny.UnityEditor.Build.Content.LuaBuildUsageTagGlobal>(out var _p2_UnityEditor_Build_Content_BuildUsageTagGlobal))
                    {
                        var _arg3 = _lastArg = _argCount > 3 ? _context.GetArgument(3) : global::Lua.LuaValue.Nil;
                        _lastArgPos = 3; _expectedType = typeof(global::Luny.UnityEditor.Build.Content.LuaBuildUsageTagSet);
                        if (_arg3.TryRead<global::Luny.UnityEditor.Build.Content.LuaBuildUsageTagSet>(out var _p3_UnityEditor_Build_Content_BuildUsageTagSet))
                        {
                            if (_argCount == 4)
                            {
                            ...
                            _lastArgPos = 4; _expectedType = typeof(global::Luny.UnityEditor.Build.Content.LuaBuildUsageCache);
                            if (_arg4.TryRead<global::Luny.UnityEditor.Build.Content.LuaBuildUsageCache>(out var _p4_UnityEditor_Build_Content_BuildUsageCache))
                            {
                                if (_argCount == 5)
                                {
                                    var objectIDs = _p0_UnityEditor_Build_Content_ObjectIdentifierArray;
        ...
        private static readonly global::Lua.LuaFunction _LuaContentBuildInterface_CalculatePlayerDependenciesForGameManagers = new global::Lua.LuaFunction("CalculatePlayerDependenciesForGameManagers", (_context, _) =>
        {
            ...
            var _argCount = _context.ArgumentCount;
            var _arg0 = _lastArg = _argCount > 0 ? _context.GetArgument(0) : global::Lua.LuaValue.Nil;
            _lastArgPos = 0; _expectedType = typeof(global::Luny.UnityEditor.Build.Content.LuaBuildSettings);
            if (_arg0.TryRead<global::Luny.UnityEditor.Build.Content.LuaBuildSettings>(out var _p0_UnityEditor_Build_Content_BuildSettings))
            {
                var _arg1 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::Luny.UnityEditor.Build.Content.LuaBuildUsageTagGlobal);
                if (_arg1.TryRead<global::Luny.UnityEditor.Build.Content.LuaBuildUsageTagGlobal>(out var _p1_UnityEditor_Build_Content_BuildUsageTagGlobal))
                {
                    var _arg2 = _lastArg = _argCount > 2 ? _context.GetArgument(2) : global::Lua.LuaValue.Nil;
                    _lastArgPos = 2; _expectedType = typeof(global::Luny.UnityEditor.Build.Content.LuaBuildUsageTagSet);
                    if (_arg2.TryRead<global::Luny.UnityEditor.Build.Content.LuaBuildUsageTagSet>(out var _p2_UnityEditor_Build_Content_BuildUsageTagSet))
                    {
                        if (_argCount == 3)
                        {
                            ...
                            var _lret0 = global::Luny.UnityEditor.Build.Content.LuaGameManagerDependencyInfo.Bind(_ret0);
                            var _retCount = _context.Return(_lret0);
                            return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                        }
                        var _arg3 = _lastArg = _argCount > 3 ? _context.GetArgument(3) : global::Lua.LuaValue.Nil;
                        _lastArgPos = 3; _expectedType = typeof(global::Luny.UnityEditor.Build.Content.LuaBuildUsageCache);
                        if (_arg3.TryRead<global::Luny.UnityEditor.Build.Content.LuaBuildUsageCache>(out var _p3_UnityEditor_Build_Content_BuildUsageCache))
                        {
                            if (_argCount == 4)
                            {
                                var settings = _p0_UnityEditor_Build_Content_BuildSettings.Value;
        ...
        private static readonly global::Lua.LuaFunction _LuaContentBuildInterface_CalculatePlayerDependenciesForScene = new global::Lua.LuaFunction("CalculatePlayerDependenciesForScene", (_context, _) =>
        {
            ...
            {
                var _arg1 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::Luny.UnityEditor.Build.Content.LuaBuildSettings);
                if (_arg1.TryRead<global::Luny.UnityEditor.Build.Content.LuaBuildSettings>(out var _p1_UnityEditor_Build_Content_BuildSettings))
                {
                    var _arg2 = _lastArg = _argCount > 2 ? _context.GetArgument(2) : global::Lua.LuaValue.Nil;
                    _lastArgPos = 2; _expectedType = typeof(global::Luny.UnityEditor.Build.Content.LuaBuildUsageTagSet);
                    if (_arg2.TryRead<global::Luny.UnityEditor.Build.Content.LuaBuildUsageTagSet>(out var _p2_UnityEditor_Build_Content_BuildUsageTagSet))
                    {
                        if (_argCount == 3)
                        {
                            ...
                            var _lret0 = global::Luny.UnityEditor.Build.Content.LuaSceneDependencyInfo.Bind(_ret0);
                            var _retCount = _context.Return(_lret0);
                            return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                        }
                        var _arg3 = _lastArg = _argCount > 3 ? _context.GetArgument(3) : global::Lua.LuaValue.Nil;
        ...
        private static readonly global::Lua.LuaFunction _LuaContentBuildInterface_CalculatePlayerSerializationHashForType = new global::Lua.LuaFunction("CalculatePlayerSerializationHashForType", (_context, _) =>
        {
            ...
            {
                var _arg1 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::Luny.UnityEditor.Build.Player.LuaTypeDB);
                if (_arg1.TryRead<global::Luny.UnityEditor.Build.Player.LuaTypeDB>(out var _p1_UnityEditor_Build_Player_TypeDB))
                {
                    if (_argCount == 2)
                    {
        ...
        private static readonly global::Lua.LuaFunction _LuaContentBuildInterface_GetGlobalUsageFromActiveScene = new global::Lua.LuaFunction("GetGlobalUsageFromActiveScene", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::UnityEditor.BuildTarget>(out var _p0_UnityEditor_BuildTarget))
            {
                if (_argCount == 1)
                {
                    ...
                    var _lret0 = global::Luny.UnityEditor.Build.Content.LuaBuildUsageTagGlobal.Bind(_ret0);
                    var _retCount = _context.Return(_lret0);
                    return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                }
            }
        ...
        private static readonly global::Lua.LuaFunction _LuaContentBuildInterface_GetPlayerDependenciesForObject = new global::Lua.LuaFunction("GetPlayerDependenciesForObject", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::Luny.UnityEditor.Build.Content.LuaObjectIdentifier>(out var _p0_UnityEditor_Build_Content_ObjectIdentifier))
            {
                ...
                {
                    var _arg2 = _lastArg = _argCount > 2 ? _context.GetArgument(2) : global::Lua.LuaValue.Nil;
                    _lastArgPos = 2; _expectedType = typeof(global::Luny.UnityEditor.Build.Player.LuaTypeDB);
                    if (_arg2.TryRead<global::Luny.UnityEditor.Build.Player.LuaTypeDB>(out var _p2_UnityEditor_Build_Player_TypeDB))
                    {
                        if (_argCount == 3)
                        {
        ...
        private static readonly global::Lua.LuaFunction _LuaContentBuildInterface_WriteGameManagersSerializedFile = new global::Lua.LuaFunction("WriteGameManagersSerializedFile", (_context, _) =>
        {
            ...
            {
                var _arg1 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::Luny.UnityEditor.Build.Content.LuaWriteManagerParameters);
                if (_arg1.TryRead<global::Luny.UnityEditor.Build.Content.LuaWriteManagerParameters>(out var _p1_UnityEditor_Build_Content_WriteManagerParameters))
                {
                    if (_argCount == 2)
                    {
                        ...
                        var _lret0 = global::Luny.UnityEditor.Build.Content.LuaWriteResult.Bind(_ret0);
                        var _retCount = _context.Return(_lret0);
                        return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                    }
                }
        ...
        private static readonly global::Lua.LuaFunction _LuaContentBuildInterface_WriteSceneSerializedFile = new global::Lua.LuaFunction("WriteSceneSerializedFile", (_context, _) =>
        {
            ...
            {
                var _arg1 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::Luny.UnityEditor.Build.Content.LuaWriteSceneParameters);
                if (_arg1.TryRead<global::Luny.UnityEditor.Build.Content.LuaWriteSceneParameters>(out var _p1_UnityEditor_Build_Content_WriteSceneParameters))
                {
                    if (_argCount == 2)
                    {
                        var outputFolder = _p0_System_String;
        ...
        private static readonly global::Lua.LuaFunction _LuaContentBuildInterface_WriteSerializedFile = new global::Lua.LuaFunction("WriteSerializedFile", (_context, _) =>
        {
            ...
            {
                var _arg1 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::Luny.UnityEditor.Build.Content.LuaWriteParameters);
                if (_arg1.TryRead<global::Luny.UnityEditor.Build.Content.LuaWriteParameters>(out var _p1_UnityEditor_Build_Content_WriteParameters))
                {
                    if (_argCount == 2)
                    {
                        var outputFolder = _p0_System_String;
