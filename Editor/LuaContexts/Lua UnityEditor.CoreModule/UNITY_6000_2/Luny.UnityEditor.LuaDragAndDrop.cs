...
{
    public sealed class LuaDragAndDrop : global::Luny.ILuaObject<global::UnityEditor.DragAndDrop>
    {
        public new static global::Lua.LuaValue Bind(global::UnityEditor.DragAndDrop instance) => new LuaDragAndDrop(instance);
        public new static global::Lua.LuaValue Bind(global::System.Object instance) => Bind((global::UnityEditor.DragAndDrop)instance);
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::UnityEditor.DragAndDrop> instances) =>
            new global::Luny.LuaList<global::UnityEditor.DragAndDrop>(instances);
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::System.Object> instances) =>
            new global::Luny.LuaList<global::UnityEditor.DragAndDrop>(instances);
        private LuaDragAndDrop(global::UnityEditor.DragAndDrop instance) => m_Instance = instance;
        public static implicit operator global::Lua.LuaValue(LuaDragAndDrop value) => new(value);
        private global::UnityEditor.DragAndDrop m_Instance;
        ...
        {
            var _this = _context.GetArgument<LuaDragAndDrop>(0);
    ...
    public sealed class LuaDragAndDropType : global::Luny.ILuaStatic
    {
        public static global::Lua.LuaValue Bind() => new LuaDragAndDropType();
        ...
        private static readonly global::Lua.LuaFunction _LuaDragAndDrop_new = new global::Lua.LuaFunction(".ctor", (_context, _) =>
        {
            ...
            if (_argCount == 0)
            {
                var _ret0 = new global::UnityEditor.DragAndDrop();
                var _factory = _context.GetObjectFactory();
        ...
        private static readonly global::Lua.LuaFunction _LuaDragAndDrop_AcceptDrag = new global::Lua.LuaFunction("AcceptDrag", (_context, _) =>
        {
            global::Lua.LuaValue _lastArg = default;
            global::System.Int32 _lastArgPos = default;
            global::System.Type _expectedType = default;
        ...
        private static readonly global::Lua.LuaFunction _LuaDragAndDrop_GetGenericData = new global::Lua.LuaFunction("GetGenericData", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::System.String>(out var _p0_System_String))
            {
                if (_argCount == 1)
                {
                    ...
                    var _ret0 = global::UnityEditor.DragAndDrop.GetGenericData(type);
                    var _factory = _context.GetObjectFactory();
                    var _lret0 = _factory.Bind(_ret0);
                    var _retCount = _context.Return(_lret0);
                    return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
        ...
        private static readonly global::Lua.LuaFunction _LuaDragAndDrop_PrepareStartDrag = new global::Lua.LuaFunction("PrepareStartDrag", (_context, _) =>
        {
            ...
            if (_argCount == 0)
            {
                global::UnityEditor.DragAndDrop.PrepareStartDrag();
                var _retCount = _context.Return();
                return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
            }
        ...
        private static readonly global::Lua.LuaFunction _LuaDragAndDrop_SetGenericData = new global::Lua.LuaFunction("SetGenericData", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::System.String>(out var _p0_System_String))
            {
                ...
                if (_arg1.TryRead<global::System.Object>(out var _p1_System_Object))
                {
                    ...
                    {
                        var type = _p0_System_String;
                        var data = _p1_System_Object;
                        global::UnityEditor.DragAndDrop.SetGenericData(type, data);
                        var _retCount = _context.Return();
                        return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                    }
                }
            }
            throw new global::Lua.LuaRuntimeException(_context.Thread, $"{"SetGenericData"}: invalid argument #{_lastArgPos}: {_lastArg} ({_lastArg.Type}), expected: {_expectedType.FullName}", 2);
        });
        private static readonly global::Lua.LuaFunction _LuaDragAndDrop_StartDrag = new global::Lua.LuaFunction("StartDrag", (_context, _) =>
        {
            global::Lua.LuaValue _lastArg = default;
            global::System.Int32 _lastArgPos = default;
            global::System.Type _expectedType = default;
            ...
            if (_arg0.TryRead<global::System.String>(out var _p0_System_String))
            {
                if (_argCount == 1)
                {
                    ...
                    global::UnityEditor.DragAndDrop.StartDrag(title);
                    var _retCount = _context.Return();
                    return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                }
            }
            throw new global::Lua.LuaRuntimeException(_context.Thread, $"{"StartDrag"}: invalid argument #{_lastArgPos}: {_lastArg} ({_lastArg.Type}), expected: {_expectedType.FullName}", 2);
        });
        private static readonly global::Lua.LuaFunction __index = new(global::Lua.Runtime.Metamethods.Index, (_context, _) =>
        {
            var _this = _context.GetArgument<LuaDragAndDropType>(0);
            var _key = _context.GetArgument(1);
            var _factory = _context.GetObjectFactory();
            global::Lua.LuaValue _value = global::Lua.LuaValue.Nil;
            if (_key.Type == global::Lua.LuaValueType.Number && _key.TryRead<global::System.Int32>(out var _index) && _this.TryGetLuaValue(_index, out _value, _factory))
        ...
        public global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                case "new": _value = _LuaDragAndDrop_new; return true;
                ...
                case "objectReferences": _value = _factory.Bind(global::UnityEditor.DragAndDrop.objectReferences); return true;
                case "paths": _value = _factory.Bind(global::UnityEditor.DragAndDrop.paths); return true;
                case "visualMode": _value = new global::Lua.LuaValue((global::System.Int64)global::UnityEditor.DragAndDrop.visualMode); return true;
                default: _value = global::Lua.LuaValue.Nil; return false;
            }
        }
        public global::System.Boolean TrySetLuaValue(global::System.Int32 _key, global::Lua.LuaValue _value)
        ...
        public global::System.Boolean TrySetLuaValue(global::System.String _key, global::Lua.LuaValue _value)
        {
            switch (_key)
            {
                case "activeControlID": global::UnityEditor.DragAndDrop.activeControlID = _value.Read<global::System.Int32>();  return true;
                case "objectReferences": global::UnityEditor.DragAndDrop.objectReferences = _value.Read<global::UnityEngine.Object[]>();  return true;
                case "paths": global::UnityEditor.DragAndDrop.paths = _value.Read<global::System.String[]>();  return true;
                case "visualMode": global::UnityEditor.DragAndDrop.visualMode = _value.Read<global::UnityEditor.DragAndDropVisualMode>();  return true;
                default: return false;
            }
        }
    }
