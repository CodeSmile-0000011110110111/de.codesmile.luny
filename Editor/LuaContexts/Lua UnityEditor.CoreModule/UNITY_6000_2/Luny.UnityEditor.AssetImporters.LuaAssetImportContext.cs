...
{
    public sealed class LuaAssetImportContext : global::Luny.ILuaObject<global::UnityEditor.AssetImporters.AssetImportContext>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::System.Object> instances) =>
            new global::Luny.LuaList<global::UnityEditor.AssetImporters.AssetImportContext>(instances);
        private LuaAssetImportContext(global::UnityEditor.AssetImporters.AssetImportContext instance) => m_Instance = instance;
        public static implicit operator global::Lua.LuaValue(LuaAssetImportContext value) => new(value);
        private global::UnityEditor.AssetImporters.AssetImportContext m_Instance;
        ...
        private static readonly global::Lua.LuaFunction _LuaAssetImportContext_AddObjectToAsset = new global::Lua.LuaFunction("AddObjectToAsset", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::System.String>(out var _p0_System_String))
            {
                ...
                if (_arg1.TryRead<global::UnityEngine.Object>(out var _p1_UnityEngine_Object))
                {
                    ...
                    if (_arg2.TryRead<global::UnityEngine.Texture2D>(out var _p2_UnityEngine_Texture2D))
                    {
                        if (_argCount == 4)
                        {
                            var identifier = _p0_System_String;
                            var obj = _p1_UnityEngine_Object;
                            var thumbnail = _p2_UnityEngine_Texture2D;
        ...
        private static readonly global::Lua.LuaFunction _LuaAssetImportContext_LogImportError = new global::Lua.LuaFunction("LogImportError", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::System.String>(out var _p0_System_String))
            {
                ...
                var _arg1 = _lastArg = _argCount > 2 ? _context.GetArgument(2) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::UnityEngine.Object);
                var _p1_UnityEngine_Object = _arg1.ReadValue<global::UnityEngine.Object>(default);
                {
                    if (_argCount == 3)
                    {
                        var msg = _p0_System_String;
