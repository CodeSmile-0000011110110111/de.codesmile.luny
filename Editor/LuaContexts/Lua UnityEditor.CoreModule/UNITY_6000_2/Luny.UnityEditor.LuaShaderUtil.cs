...
namespace Luny.UnityEditor
{
    ...
    public sealed class LuaShaderUtilType : global::Luny.ILuaStatic
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaShaderUtil_GetCallableShaderCount = new global::Lua.LuaFunction("GetCallableShaderCount", (_context, _) =>
        {
            ...
            var _argCount = _context.ArgumentCount;
            var _arg0 = _lastArg = _argCount > 0 ? _context.GetArgument(0) : global::Lua.LuaValue.Nil;
            _lastArgPos = 0; _expectedType = typeof(global::UnityEngine.Rendering.RayTracingShader);
            if (_arg0.TryRead<global::UnityEngine.Rendering.RayTracingShader>(out var _p0_UnityEngine_Rendering_RayTracingShader))
            {
                if (_argCount == 1)
                {
                    var s = _p0_UnityEngine_Rendering_RayTracingShader;
        ...
        private static readonly global::Lua.LuaFunction _LuaShaderUtil_GetComputeShaderMessageCount = new global::Lua.LuaFunction("GetComputeShaderMessageCount", (_context, _) =>
        {
            ...
            var _argCount = _context.ArgumentCount;
            var _arg0 = _lastArg = _argCount > 0 ? _context.GetArgument(0) : global::Lua.LuaValue.Nil;
            _lastArgPos = 0; _expectedType = typeof(global::UnityEngine.ComputeShader);
            if (_arg0.TryRead<global::UnityEngine.ComputeShader>(out var _p0_UnityEngine_ComputeShader))
            {
                if (_argCount == 1)
                {
                    var s = _p0_UnityEngine_ComputeShader;
        ...
        private static readonly global::Lua.LuaFunction _LuaShaderUtil_GetShaderInfo = new global::Lua.LuaFunction("GetShaderInfo", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::UnityEngine.Shader>(out var _p0_UnityEngine_Shader))
            {
                if (_argCount == 1)
                {
                    ...
                    var _lret0 = global::Luny.UnityEditor.LuaShaderInfo.Bind(_ret0);
                    var _retCount = _context.Return(_lret0);
                    return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                }
            }
        ...
        private static readonly global::Lua.LuaFunction _LuaShaderUtil_RestoreAsyncCompilation = new global::Lua.LuaFunction("RestoreAsyncCompilation", (_context, _) =>
        {
            ...
            var _argCount = _context.ArgumentCount;
            var _arg0 = _lastArg = _argCount > 0 ? _context.GetArgument(0) : global::Lua.LuaValue.Nil;
            _lastArgPos = 0; _expectedType = typeof(global::UnityEngine.Rendering.CommandBuffer);
            if (_arg0.TryRead<global::UnityEngine.Rendering.CommandBuffer>(out var _p0_UnityEngine_Rendering_CommandBuffer))
            {
                if (_argCount == 1)
                {
                    var cmd = _p0_UnityEngine_Rendering_CommandBuffer;
                ...
                if (_arg1.TryRead<global::UnityEngine.Shader>(out var _p1_UnityEngine_Shader))
                {
                    ...
                    if (_arg2.TryRead<global::System.String>(out var _p2_System_String))
                    {
                        ...
                        if (_arg3.TryRead<global::System.Boolean>(out var _p3_System_Boolean))
                        {
                            ...
                            {
                                var context = _p0_UnityEditor_AssetImporters_AssetImportContext.Instance;
                                var shader = _p1_UnityEngine_Shader;
        ...
        public global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                case "new": _value = _LuaShaderUtil_new; return true;
