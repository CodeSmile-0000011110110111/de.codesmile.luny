...
namespace Luny.UnityEditor.U2D
{
    public sealed class LuaSpriteAtlasExtensionsType : global::Luny.ILuaStatic
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaSpriteAtlasExtensions_Add = new global::Lua.LuaFunction("Add", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::UnityEngine.U2D.SpriteAtlas>(out var _p0_UnityEngine_U2D_SpriteAtlas))
            {
                ...
                if (_arg1.TryReadArray<global::UnityEngine.Object>(out var _p1_UnityEngine_ObjectArray))
                {
                    if (_argCount == 2)
                    {
                        var spriteAtlas = _p0_UnityEngine_U2D_SpriteAtlas;
        ...
        private static readonly global::Lua.LuaFunction _LuaSpriteAtlasExtensions_GetPackingSettings = new global::Lua.LuaFunction("GetPackingSettings", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::UnityEngine.U2D.SpriteAtlas>(out var _p0_UnityEngine_U2D_SpriteAtlas))
            {
                if (_argCount == 1)
                {
                    ...
                    var _lret0 = global::Luny.UnityEditor.U2D.LuaSpriteAtlasPackingSettings.Bind(_ret0);
                    var _retCount = _context.Return(_lret0);
                    return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                }
            }
        ...
        private static readonly global::Lua.LuaFunction _LuaSpriteAtlasExtensions_GetTextureSettings = new global::Lua.LuaFunction("GetTextureSettings", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::UnityEngine.U2D.SpriteAtlas>(out var _p0_UnityEngine_U2D_SpriteAtlas))
            {
                if (_argCount == 1)
                {
                    ...
                    var _lret0 = global::Luny.UnityEditor.U2D.LuaSpriteAtlasTextureSettings.Bind(_ret0);
                    var _retCount = _context.Return(_lret0);
                    return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                }
            }
        ...
        private static readonly global::Lua.LuaFunction _LuaSpriteAtlasExtensions_SetMasterAtlas = new global::Lua.LuaFunction("SetMasterAtlas", (_context, _) =>
        {
            ...
            {
                var _arg1 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::UnityEngine.U2D.SpriteAtlas);
                if (_arg1.TryRead<global::UnityEngine.U2D.SpriteAtlas>(out var _p1_UnityEngine_U2D_SpriteAtlas))
                {
                    if (_argCount == 2)
                    {
                        var spriteAtlas = _p0_UnityEngine_U2D_SpriteAtlas;
                        var value = _p1_UnityEngine_U2D_SpriteAtlas;
        ...
        private static readonly global::Lua.LuaFunction _LuaSpriteAtlasExtensions_SetPackingSettings = new global::Lua.LuaFunction("SetPackingSettings", (_context, _) =>
        {
            ...
            {
                var _arg1 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::Luny.UnityEditor.U2D.LuaSpriteAtlasPackingSettings);
                if (_arg1.TryRead<global::Luny.UnityEditor.U2D.LuaSpriteAtlasPackingSettings>(out var _p1_UnityEditor_U2D_SpriteAtlasPackingSettings))
                {
                    if (_argCount == 2)
                    {
                        var spriteAtlas = _p0_UnityEngine_U2D_SpriteAtlas;
        ...
        private static readonly global::Lua.LuaFunction _LuaSpriteAtlasExtensions_SetPlatformSettings = new global::Lua.LuaFunction("SetPlatformSettings", (_context, _) =>
        {
            ...
            {
                var _arg1 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::Luny.UnityEditor.LuaTextureImporterPlatformSettings);
                if (_arg1.TryRead<global::Luny.UnityEditor.LuaTextureImporterPlatformSettings>(out var _p1_UnityEditor_TextureImporterPlatformSettings))
                {
                    if (_argCount == 2)
                    {
                        var spriteAtlas = _p0_UnityEngine_U2D_SpriteAtlas;
