...
{
    public sealed class LuaCommandServiceType : global::Luny.ILuaStatic
    {
        public static global::Lua.LuaValue Bind() => new LuaCommandServiceType();
        ...
        private static readonly global::Lua.LuaFunction _LuaCommandService_Execute = new global::Lua.LuaFunction("Execute", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::System.String>(out var _p0_System_String))
            {
                if (_argCount == 1)
                {
                    ...
                    var _ret0 = global::UnityEditor.CommandService.Execute(id);
                ...
                _lastArgPos = 1; _expectedType = typeof(global::UnityEditor.CommandHint);
                if (_arg1.TryRead<global::UnityEditor.CommandHint>(out var _p1_UnityEditor_CommandHint))
                {
                    if (_argCount == 2)
                    {
                        var id = _p0_System_String;
                        var hint = _p1_UnityEditor_CommandHint;
                        var _ret0 = global::UnityEditor.CommandService.Execute(id, hint);
                        var _factory = _context.GetObjectFactory();
                        var _lret0 = _factory.Bind(_ret0);
                        var _retCount = _context.Return(_lret0);
                        return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                    ...
                    if (_arg2.TryReadArray<global::System.Object>(out var _p2_System_ObjectArray))
                    {
                        if (_argCount == 3)
                        {
                            ...
                            var _ret0 = global::UnityEditor.CommandService.Execute(id, hint, args);
                            var _factory = _context.GetObjectFactory();
                            var _lret0 = _factory.Bind(_ret0);
                            var _retCount = _context.Return(_lret0);
                            return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
            ...
            throw new global::Lua.LuaRuntimeException(_context.Thread, $"{"Execute"}: invalid argument #{_lastArgPos}: {_lastArg} ({_lastArg.Type}), expected: {_expectedType.FullName}", 2);
        });
        private static readonly global::Lua.LuaFunction _LuaCommandService_Exists = new global::Lua.LuaFunction("Exists", (_context, _) =>
        {
            global::Lua.LuaValue _lastArg = default;
            global::System.Int32 _lastArgPos = default;
            global::System.Type _expectedType = default;
            ...
            if (_arg0.TryRead<global::System.String>(out var _p0_System_String))
            {
                ...
                {
                    var id = _p0_System_String;
                    var _ret0 = global::UnityEditor.CommandService.Exists(id);
        ...
        private static readonly global::Lua.LuaFunction _LuaCommandService_GetCommandLabel = new global::Lua.LuaFunction("GetCommandLabel", (_context, _) =>
        {
            global::Lua.LuaValue _lastArg = default;
            global::System.Int32 _lastArgPos = default;
            global::System.Type _expectedType = default;
            ...
            if (_arg0.TryRead<global::System.String>(out var _p0_System_String))
            {
                if (_argCount == 1)
                {
                    var commandId = _p0_System_String;
                    var _ret0 = global::UnityEditor.CommandService.GetCommandLabel(commandId);
                    var _lret0 = new global::Lua.LuaValue(_ret0);
                    var _retCount = _context.Return(_lret0);
                    return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                }
        ...
        private static readonly global::Lua.LuaFunction _LuaCommandService_UnregisterCommand = new global::Lua.LuaFunction("UnregisterCommand", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::System.String>(out var _p0_System_String))
            {
                ...
                {
                    var id = _p0_System_String;
                    var _ret0 = global::UnityEditor.CommandService.UnregisterCommand(id);
                    var _lret0 = new global::Lua.LuaValue(_ret0);
                    var _retCount = _context.Return(_lret0);
                    return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                }
            }
            throw new global::Lua.LuaRuntimeException(_context.Thread, $"{"UnregisterCommand"}: invalid argument #{_lastArgPos}: {_lastArg} ({_lastArg.Type}), expected: {_expectedType.FullName}", 2);
        });
        private static readonly global::Lua.LuaFunction __index = new(global::Lua.Runtime.Metamethods.Index, (_context, _) =>
        {
            var _this = _context.GetArgument<LuaCommandServiceType>(0);
