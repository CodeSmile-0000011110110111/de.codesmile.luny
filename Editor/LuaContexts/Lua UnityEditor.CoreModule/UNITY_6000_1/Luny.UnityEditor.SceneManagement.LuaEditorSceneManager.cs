...
{
    public sealed class LuaEditorSceneManager : global::Luny.ILuaObject<global::UnityEditor.SceneManagement.EditorSceneManager>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::System.Object> instances) =>
            new global::Luny.LuaList<global::UnityEditor.SceneManagement.EditorSceneManager>(instances);
        private LuaEditorSceneManager(global::UnityEditor.SceneManagement.EditorSceneManager instance) => m_Instance = instance;
        public static implicit operator global::Lua.LuaValue(LuaEditorSceneManager value) => new(value);
        private global::UnityEditor.SceneManagement.EditorSceneManager m_Instance;
        public global::UnityEditor.SceneManagement.EditorSceneManager Instance => m_Instance;
    ...
    public sealed class LuaEditorSceneManagerType : global::Luny.ILuaStatic
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaEditorSceneManager_LoadSceneAsyncInPlayMode = new global::Lua.LuaFunction("LoadSceneAsyncInPlayMode", (_context, _) =>
        {
            ...
            {
                var _arg1 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::UnityEngine.SceneManagement.LoadSceneParameters);
                if (_arg1.TryRead<global::UnityEngine.SceneManagement.LoadSceneParameters>(out var _p1_UnityEngine_SceneManagement_LoadSceneParameters))
                {
                    if (_argCount == 2)
                    {
                        var path = _p0_System_String;
                        var parameters = _p1_UnityEngine_SceneManagement_LoadSceneParameters;
        ...
        private static readonly global::Lua.LuaFunction _LuaEditorSceneManager_MoveSceneAfter = new global::Lua.LuaFunction("MoveSceneAfter", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::UnityEngine.SceneManagement.Scene>(out var _p0_UnityEngine_SceneManagement_Scene))
            {
                ...
                if (_arg1.TryRead<global::UnityEngine.SceneManagement.Scene>(out var _p1_UnityEngine_SceneManagement_Scene))
                {
                    if (_argCount == 2)
                    {
                        var src = _p0_UnityEngine_SceneManagement_Scene;
                        var dst = _p1_UnityEngine_SceneManagement_Scene;
        ...
        public global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                case "new": _value = _LuaEditorSceneManager_new; return true;
        ...
        public global::System.Boolean TrySetLuaValue(global::System.String _key, global::Lua.LuaValue _value)
        {
            switch (_key)
            {
                case "playModeStartScene": global::UnityEditor.SceneManagement.EditorSceneManager.playModeStartScene = _value.Read<global::Luny.UnityEditor.LuaSceneAsset>().Instance;  return true;
