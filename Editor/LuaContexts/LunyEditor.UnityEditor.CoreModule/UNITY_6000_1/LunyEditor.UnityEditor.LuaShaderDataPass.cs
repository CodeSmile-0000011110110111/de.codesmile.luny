...
{
    public class LuaShaderDataPass : global::Luny.ILuaObject<global::UnityEditor.ShaderData.Pass>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::System.Object> instances) =>
            new global::Luny.LuaList<global::UnityEditor.ShaderData.Pass>(instances);
        protected LuaShaderDataPass(global::UnityEditor.ShaderData.Pass instance) => m_Instance = instance;
        public static implicit operator global::Lua.LuaValue(LuaShaderDataPass value) => new(value);
        protected global::UnityEditor.ShaderData.Pass m_Instance;
                    ...
                    if (_arg2.TryRead<global::UnityEditor.Rendering.ShaderCompilerPlatform>(out var _p2_UnityEditor_Rendering_ShaderCompilerPlatform))
                    {
                        ...
                        if (_arg3.TryRead<global::UnityEditor.BuildTarget>(out var _p3_UnityEditor_BuildTarget))
                        {
                            if (_argCount == 5)
                            {
                                ...
                                var _lret0 = global::LunyEditor.UnityEditor.LuaShaderDataVariantCompileInfo.Bind(_ret0);
        ...
        private static readonly global::Lua.LuaFunction _LuaShaderDataPass_FindTagValue = new global::Lua.LuaFunction("FindTagValue", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.Rendering.LuaShaderTagId>(out var _p0_UnityEngine_Rendering_ShaderTagId))
            {
                if (_argCount == 2)
                {
                    var tagName = _p0_UnityEngine_Rendering_ShaderTagId.Value;
                        ...
                        if (_arg3.TryRead<global::UnityEditor.BuildTarget>(out var _p3_UnityEditor_BuildTarget))
                        {
                            ...
                            if (_arg4.TryRead<global::System.Boolean>(out var _p4_System_Boolean))
                            {
                                if (_argCount == 6)
                                {
                                    ...
                                    var _lret0 = global::LunyEditor.UnityEditor.LuaShaderDataPreprocessedVariant.Bind(_ret0);
                                    var _retCount = _context.Return(_lret0);
                                    return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                                }
                            }
