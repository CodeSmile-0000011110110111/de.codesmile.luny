...
{
    public sealed class LuaAnimatorStateMachine : global::Luny.UnityEngine.LuaUnityObject, global::Luny.ILuaObject<global::UnityEditor.Animations.AnimatorStateMachine>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::System.Object> instances) =>
            new global::Luny.LuaList<global::UnityEditor.Animations.AnimatorStateMachine>(instances);
        private LuaAnimatorStateMachine(global::UnityEditor.Animations.AnimatorStateMachine instance) : base(instance) {}
        public static implicit operator global::Lua.LuaValue(LuaAnimatorStateMachine value) => new(value);
        public new global::UnityEditor.Animations.AnimatorStateMachine Instance => (global::UnityEditor.Animations.AnimatorStateMachine)m_Instance;
        ...
        private static readonly global::Lua.LuaFunction _LuaAnimatorStateMachine_AddStateMachineTransition = new global::Lua.LuaFunction("AddStateMachineTransition", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::LunyEditor.UnityEditor.Animations.LuaAnimatorStateMachine>(out var _p0_UnityEditor_Animations_AnimatorStateMachine))
            {
                ...
                _lastArgPos = 1; _expectedType = typeof(global::LunyEditor.UnityEditor.Animations.LuaAnimatorStateMachine);
                if (_arg1.TryRead<global::LunyEditor.UnityEditor.Animations.LuaAnimatorStateMachine>(out var _p1_UnityEditor_Animations_AnimatorStateMachine))
                {
                    if (_argCount == 3)
                    {
                        var sourceStateMachine = _p0_UnityEditor_Animations_AnimatorStateMachine.Instance;
        ...
        private static readonly global::Lua.LuaFunction _LuaAnimatorStateMachine_RemoveEntryTransition = new global::Lua.LuaFunction("RemoveEntryTransition", (_context, _) =>
        {
            ...
            var _this = _context.GetArgument<LuaAnimatorStateMachine>(0);
            var _arg0 = _lastArg = _argCount > 1 ? _context.GetArgument(1) : global::Lua.LuaValue.Nil;
            _lastArgPos = 0; _expectedType = typeof(global::LunyEditor.UnityEditor.Animations.LuaAnimatorTransition);
            if (_arg0.TryRead<global::LunyEditor.UnityEditor.Animations.LuaAnimatorTransition>(out var _p0_UnityEditor_Animations_AnimatorTransition))
            {
                if (_argCount == 2)
                {
        ...
        private static readonly global::Lua.LuaFunction _LuaAnimatorStateMachine_RemoveStateMachineTransition = new global::Lua.LuaFunction("RemoveStateMachineTransition", (_context, _) =>
        {
            ...
            {
                var _arg1 = _lastArg = _argCount > 2 ? _context.GetArgument(2) : global::Lua.LuaValue.Nil;
                _lastArgPos = 1; _expectedType = typeof(global::LunyEditor.UnityEditor.Animations.LuaAnimatorTransition);
                if (_arg1.TryRead<global::LunyEditor.UnityEditor.Animations.LuaAnimatorTransition>(out var _p1_UnityEditor_Animations_AnimatorTransition))
                {
                    if (_argCount == 3)
                    {
                        var sourceStateMachine = _p0_UnityEditor_Animations_AnimatorStateMachine.Instance;
        ...
        public override global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                ...
                case "anyStatePosition": _value = global::Luny.UnityEngine.LuaVector3.Bind(Instance.anyStatePosition); return true;
                ...
                case "entryPosition": _value = global::Luny.UnityEngine.LuaVector3.Bind(Instance.entryPosition); return true;
                case "entryTransitions": _value = _factory.Bind(Instance.entryTransitions); return true;
                case "exitPosition": _value = global::Luny.UnityEngine.LuaVector3.Bind(Instance.exitPosition); return true;
                case "parentStateMachinePosition": _value = global::Luny.UnityEngine.LuaVector3.Bind(Instance.parentStateMachinePosition); return true;
        ...
        public override global::System.Boolean TrySetLuaValue(global::System.String _key, global::Lua.LuaValue _value)
        {
            switch (_key)
            {
                case "anyStatePosition": Instance.anyStatePosition = _value.Read<global::Luny.UnityEngine.LuaVector3>().Value;  return true;
                ...
                case "defaultState": Instance.defaultState = _value.Read<global::LunyEditor.UnityEditor.Animations.LuaAnimatorState>().Instance;  return true;
                case "entryPosition": Instance.entryPosition = _value.Read<global::Luny.UnityEngine.LuaVector3>().Value;  return true;
                case "entryTransitions": Instance.entryTransitions = _value.Read<global::UnityEditor.Animations.AnimatorTransition[]>();  return true;
                case "exitPosition": Instance.exitPosition = _value.Read<global::Luny.UnityEngine.LuaVector3>().Value;  return true;
                case "parentStateMachinePosition": Instance.parentStateMachinePosition = _value.Read<global::Luny.UnityEngine.LuaVector3>().Value;  return true;
    ...
    public sealed class LuaAnimatorStateMachineType : global::Luny.ILuaStatic
    {
        ...
        private static global::Lua.LuaTable CreateMetatable()
        {
            ...
            metatable[global::Lua.Runtime.Metamethods.Concat] = global::Luny.LuaMetatable.ConcatMetamethod;
            metatable[global::Lua.Runtime.Metamethods.ToString] = global::Luny.LuaMetatable.ToStringMetamethod;
            metatable[global::Lua.Runtime.Metamethods.Call] = _LuaAnimatorStateMachine_new;
            return metatable;
        }
        private static global::Lua.LuaTable s_Metatable;
