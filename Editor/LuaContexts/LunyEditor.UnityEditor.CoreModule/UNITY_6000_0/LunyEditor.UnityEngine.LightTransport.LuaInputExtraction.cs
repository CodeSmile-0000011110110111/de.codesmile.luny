...
namespace LunyEditor.UnityEngine.LightTransport
{
    public sealed class LuaInputExtractionType : global::Luny.ILuaStatic
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaInputExtraction_ComputeOcclusionLightIndicesFromBakeInput = new global::Lua.LuaFunction("ComputeOcclusionLightIndicesFromBakeInput", (_context, _) =>
        {
            ...
            _lastArgPos = 0; _expectedType = typeof(global::LunyEditor.UnityEngine.LightTransport.LuaInputExtractionBakeInput);
            if (_arg0.TryRead<global::LunyEditor.UnityEngine.LightTransport.LuaInputExtractionBakeInput>(out var _p0_UnityEngine_LightTransport_InputExtraction_BakeInput))
            {
