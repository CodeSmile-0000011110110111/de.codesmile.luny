        ...
        private static readonly global::Lua.LuaFunction _LuaMaterialPropertyDrawer_GetPropertyHeight = new global::Lua.LuaFunction("GetPropertyHeight", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::LunyEditor.UnityEditor.LuaMaterialProperty>(out var _p0_UnityEditor_MaterialProperty))
            {
                ...
                if (_arg1.TryRead<global::System.String>(out var _p1_System_String))
                {
                    ...
                    _lastArgPos = 2; _expectedType = typeof(global::LunyEditor.UnityEditor.LuaMaterialEditor);
                    if (_arg2.TryRead<global::LunyEditor.UnityEditor.LuaMaterialEditor>(out var _p2_UnityEditor_MaterialEditor))
                    {
                        if (_argCount == 4)
                        {
                            var prop = _p0_UnityEditor_MaterialProperty.Instance;
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaRect>(out var _p0_UnityEngine_Rect))
            {
                ...
                if (_arg1.TryRead<global::LunyEditor.UnityEditor.LuaMaterialProperty>(out var _p1_UnityEditor_MaterialProperty))
                {
                    ...
                    if (_arg2.TryRead<global::System.String>(out var _p2_System_String))
                    {
                        ...
                        _lastArgPos = 3; _expectedType = typeof(global::LunyEditor.UnityEditor.LuaMaterialEditor);
                        if (_arg3.TryRead<global::LunyEditor.UnityEditor.LuaMaterialEditor>(out var _p3_UnityEditor_MaterialEditor))
                        {
                            if (_argCount == 5)
                            {
