...
namespace LunyEditor.UnityEditor.Build
{
    public sealed class LuaNamedBuildTarget : global::Luny.ILuaValueType<global::UnityEditor.Build.NamedBuildTarget>
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaNamedBuildTarget_CompareTo = new global::Lua.LuaFunction("CompareTo", (_context, _) =>
        {
            ...
            _lastArgPos = 0; _expectedType = typeof(global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget);
            if (_arg0.TryRead<global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget>(out var _p0_UnityEditor_Build_NamedBuildTarget))
            {
                if (_argCount == 2)
                {
    ...
    public sealed class LuaNamedBuildTargetType : global::Luny.ILuaStatic
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaNamedBuildTarget_FromBuildTargetGroup = new global::Lua.LuaFunction("FromBuildTargetGroup", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::UnityEditor.BuildTargetGroup>(out var _p0_UnityEditor_BuildTargetGroup))
            {
                if (_argCount == 1)
                {
                    ...
                    var _lret0 = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(_ret0);
                    var _retCount = _context.Return(_lret0);
                    return new global::System.Threading.Tasks.ValueTask<System.Int32>(_retCount);
                }
            }
        ...
        public global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                ...
                case "Android": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.Android); return true;
                case "EmbeddedLinux": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.EmbeddedLinux); return true;
                case "iOS": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.iOS); return true;
                case "LinuxHeadlessSimulation": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.LinuxHeadlessSimulation); return true;
                case "NintendoSwitch": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.NintendoSwitch); return true;
                case "PS4": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.PS4); return true;
                case "PS5": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.PS5); return true;
                case "QNX": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.QNX); return true;
                case "Server": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.Server); return true;
                case "Standalone": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.Standalone); return true;
                case "tvOS": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.tvOS); return true;
                case "Unknown": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.Unknown); return true;
                case "VisionOS": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.VisionOS); return true;
                case "WebGL": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.WebGL); return true;
                case "WindowsStoreApps": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.WindowsStoreApps); return true;
                case "XboxOne": _value = global::LunyEditor.UnityEditor.Build.LuaNamedBuildTarget.Bind(global::UnityEditor.Build.NamedBuildTarget.XboxOne); return true;
                default: _value = global::Lua.LuaValue.Nil; return false;
            }
        }
        public global::System.Boolean TrySetLuaValue(global::System.Int32 _key, global::Lua.LuaValue _value)
