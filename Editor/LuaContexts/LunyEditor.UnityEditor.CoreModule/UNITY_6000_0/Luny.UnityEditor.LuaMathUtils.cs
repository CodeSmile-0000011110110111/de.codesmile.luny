...
{
    public class LuaMathUtils : global::Luny.ILuaObject<global::UnityEditor.MathUtils>
    {
        ...
        public new static global::Lua.LuaValue Bind(global::System.Collections.Generic.IList<global::System.Object> instances) =>
            new global::Luny.LuaList<global::UnityEditor.MathUtils>(instances);
        protected LuaMathUtils(global::UnityEditor.MathUtils instance) => m_Instance = instance;
        public static implicit operator global::Lua.LuaValue(LuaMathUtils value) => new(value);
        protected global::UnityEditor.MathUtils m_Instance;
                ...
                if (_arg1.TryRead<global::Luny.UnityEngine.LuaQuaternion>(out var _p1_UnityEngine_Quaternion))
                {
                    ...
                    if (_arg2.TryRead<global::Luny.UnityEngine.LuaQuaternion>(out var _p2_UnityEngine_Quaternion))
                    {
                        ...
                        if (_arg3.TryRead<global::Luny.UnityEngine.LuaQuaternion>(out var _p3_UnityEngine_Quaternion))
                        {
                            ...
                            _lastArgPos = 4; _expectedType = typeof(global::Luny.UnityEngine.LuaQuaternion);
                            if (_arg4.TryRead<global::Luny.UnityEngine.LuaQuaternion>(out var _p4_UnityEngine_Quaternion))
                            {
                                if (_argCount == 5)
                                {
                                    var t = _p0_System_Single;
                                    var q0 = _p1_UnityEngine_Quaternion.Value;
                                    var q1 = _p2_UnityEngine_Quaternion.Value;
                                    var a0 = _p3_UnityEngine_Quaternion.Value;
                                    var a1 = _p4_UnityEngine_Quaternion.Value;
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaQuaternion>(out var _p0_UnityEngine_Quaternion))
            {
                ...
                if (_arg1.TryRead<global::Luny.UnityEngine.LuaQuaternion>(out var _p1_UnityEngine_Quaternion))
                {
                    ...
                    if (_arg2.TryRead<global::Luny.UnityEngine.LuaQuaternion>(out var _p2_UnityEngine_Quaternion))
                    {
                        if (_argCount == 3)
                        {
                            var q0 = _p0_UnityEngine_Quaternion.Value;
                            var q1 = _p1_UnityEngine_Quaternion.Value;
                            var q2 = _p2_UnityEngine_Quaternion.Value;
                        ...
                        if (_arg3.TryRead<global::Luny.UnityEngine.LuaVector3>(out var _p3_UnityEngine_Vector3))
                        {
                            ...
                            if (_arg4.TryRead<global::System.Boolean>(out var _p4_System_Boolean))
                            {
                                if (_argCount == 5)
                                {
                                    ...
                                    var v0 = _p1_UnityEngine_Vector3.Value;
                                    var v1 = _p2_UnityEngine_Vector3.Value;
                                    var v2 = _p3_UnityEngine_Vector3.Value;
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaQuaternion>(out var _p0_UnityEngine_Quaternion))
            {
                ...
                if (_arg1.TryRead<global::Luny.UnityEngine.LuaQuaternion>(out var _p1_UnityEngine_Quaternion))
                {
                    ...
                    if (_arg2.TryRead<global::System.Single>(out var _p2_System_Single))
                    {
                        if (_argCount == 3)
                        {
                            var p = _p0_UnityEngine_Quaternion.Value;
