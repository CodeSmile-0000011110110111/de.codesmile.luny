...
namespace LunyEditor.UnityEditor
{
    ...
    public sealed class LuaBuildPipelineType : global::Luny.ILuaStatic
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaBuildPipeline_BuildAssetBundles = new global::Lua.LuaFunction("BuildAssetBundles", (_context, _) =>
        {
            ...
            _lastArgPos = 0; _expectedType = typeof(global::LunyEditor.UnityEditor.LuaBuildAssetBundlesParameters);
            if (_arg0.TryRead<global::LunyEditor.UnityEditor.LuaBuildAssetBundlesParameters>(out var _p0_UnityEditor_BuildAssetBundlesParameters))
            {
                if (_argCount == 1)
                {
        ...
        private static readonly global::Lua.LuaFunction _LuaBuildPipeline_BuildPlayer = new global::Lua.LuaFunction("BuildPlayer", (_context, _) =>
        {
            ...
            _lastArgPos = 0; _expectedType = typeof(global::LunyEditor.UnityEditor.LuaBuildPlayerWithProfileOptions);
            if (_arg0.TryRead<global::LunyEditor.UnityEditor.LuaBuildPlayerWithProfileOptions>(out var _p0_UnityEditor_BuildPlayerWithProfileOptions))
            {
                if (_argCount == 1)
                {
