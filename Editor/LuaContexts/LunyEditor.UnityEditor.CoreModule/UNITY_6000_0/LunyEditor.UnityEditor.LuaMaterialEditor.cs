...
{
    public class LuaMaterialEditor : global::LunyEditor.UnityEditor.LuaEditor, global::Luny.ILuaObject<global::UnityEditor.MaterialEditor>
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaMaterialEditor_BeginAnimatedCheck = new global::Lua.LuaFunction("BeginAnimatedCheck", (_context, _) =>
        {
            ...
            _lastArgPos = 0; _expectedType = typeof(global::LunyEditor.UnityEditor.LuaMaterialProperty);
            if (_arg0.TryRead<global::LunyEditor.UnityEditor.LuaMaterialProperty>(out var _p0_UnityEditor_MaterialProperty))
            {
                if (_argCount == 2)
                {
            ...
            if (_arg0.TryRead<global::Luny.UnityEngine.LuaRect>(out var _p0_UnityEngine_Rect))
            {
                ...
                _lastArgPos = 1; _expectedType = typeof(global::LunyEditor.UnityEditor.LuaMaterialProperty);
                if (_arg1.TryRead<global::LunyEditor.UnityEditor.LuaMaterialProperty>(out var _p1_UnityEditor_MaterialProperty))
                {
                    if (_argCount == 3)
                    {
        ...
        private static readonly global::Lua.LuaFunction _LuaMaterialEditor_TexturePropertySingleLine = new global::Lua.LuaFunction("TexturePropertySingleLine", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::UnityEngine.GUIContent>(out var _p0_UnityEngine_GUIContent))
            {
                ...
                if (_arg1.TryRead<global::LunyEditor.UnityEditor.LuaMaterialProperty>(out var _p1_UnityEditor_MaterialProperty))
                {
                    ...
                    var _arg2 = _lastArg = _argCount > 3 ? _context.GetArgument(3) : global::Lua.LuaValue.Nil;
                    _lastArgPos = 2; _expectedType = typeof(global::LunyEditor.UnityEditor.LuaMaterialProperty);
                    if (_arg2.TryRead<global::LunyEditor.UnityEditor.LuaMaterialProperty>(out var _p2_UnityEditor_MaterialProperty))
                    {
                        if (_argCount == 4)
                        {
                            var label = _p0_UnityEngine_GUIContent;
                        ...
                        var _arg3 = _lastArg = _argCount > 4 ? _context.GetArgument(4) : global::Lua.LuaValue.Nil;
                        _lastArgPos = 3; _expectedType = typeof(global::LunyEditor.UnityEditor.LuaMaterialProperty);
                        if (_arg3.TryRead<global::LunyEditor.UnityEditor.LuaMaterialProperty>(out var _p3_UnityEditor_MaterialProperty))
                        {
                            if (_argCount == 5)
                            {
                                var label = _p0_UnityEngine_GUIContent;
            ...
            if (_arg0.TryRead<global::UnityEngine.GUIContent>(out var _p0_UnityEngine_GUIContent))
            {
                ...
                if (_arg1.TryRead<global::LunyEditor.UnityEditor.LuaMaterialProperty>(out var _p1_UnityEditor_MaterialProperty))
                {
                    ...
                    if (_arg2.TryRead<global::LunyEditor.UnityEditor.LuaMaterialProperty>(out var _p2_UnityEditor_MaterialProperty))
                    {
                        ...
                        {
                            var _arg4 = _lastArg = _argCount > 5 ? _context.GetArgument(5) : global::Lua.LuaValue.Nil;
                            _lastArgPos = 4; _expectedType = typeof(global::LunyEditor.UnityEditor.LuaMaterialProperty);
                            if (_arg4.TryRead<global::LunyEditor.UnityEditor.LuaMaterialProperty>(out var _p4_UnityEditor_MaterialProperty))
                            {
                                if (_argCount == 6)
                                {
                                    var label = _p0_UnityEngine_GUIContent;
