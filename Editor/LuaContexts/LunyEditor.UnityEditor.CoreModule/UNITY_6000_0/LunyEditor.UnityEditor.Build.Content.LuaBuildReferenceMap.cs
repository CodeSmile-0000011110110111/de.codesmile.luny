        ...
        private static readonly global::Lua.LuaFunction _LuaBuildReferenceMap_AddMapping = new global::Lua.LuaFunction("AddMapping", (_context, _) =>
        {
            ...
            if (_arg0.TryRead<global::System.String>(out var _p0_System_String))
            {
                ...
                if (_arg1.TryRead<global::System.Int64>(out var _p1_System_Int64))
                {
                    ...
                    _lastArgPos = 2; _expectedType = typeof(global::LunyEditor.UnityEditor.Build.Content.LuaObjectIdentifier);
                    if (_arg2.TryRead<global::LunyEditor.UnityEditor.Build.Content.LuaObjectIdentifier>(out var _p2_UnityEditor_Build_Content_ObjectIdentifier))
                    {
                        if (_argCount == 4)
                        {
