    ...
    public sealed class LuaChangeGameObjectParentEventArgs : global::Luny.ILuaValueType<global::UnityEditor.ChangeGameObjectParentEventArgs>
    {
        ...
        public global::System.Boolean TryGetLuaValue(global::System.String _key, out global::Lua.LuaValue _value, global::Luny.ILuaObjectFactory _factory)
        {
            switch (_key)
            {
                ...
                case "newScene": _value = global::Luny.UnityEngine.SceneManagement.LuaScene.Bind(m_Value.newScene); return true;
                case "previousParentInstanceId": _value = new global::Lua.LuaValue(m_Value.previousParentInstanceId); return true;
                case "previousScene": _value = global::Luny.UnityEngine.SceneManagement.LuaScene.Bind(m_Value.previousScene); return true;
    ...
    public sealed class LuaChangeGameObjectParentEventArgsType : global::Luny.ILuaStatic
    {
        ...
        private static readonly global::Lua.LuaFunction _LuaChangeGameObjectParentEventArgs_new = new global::Lua.LuaFunction(".ctor", (_context, _) =>
        {
            ...
            if (_argCount == 1)
            {
                ...
                var _lret0 = global::LunyEditor.UnityEditor.LuaChangeGameObjectParentEventArgs.Bind(_ret0);
            ...
            if (_arg0.TryRead<global::System.Int32>(out var _p0_System_Int32))
            {
                ...
                if (_arg1.TryRead<global::Luny.UnityEngine.SceneManagement.LuaScene>(out var _p1_UnityEngine_SceneManagement_Scene))
                {
                    ...
                    if (_arg2.TryRead<global::System.Int32>(out var _p2_System_Int32))
                    {
                        ...
                        _lastArgPos = 3; _expectedType = typeof(global::Luny.UnityEngine.SceneManagement.LuaScene);
                        if (_arg3.TryRead<global::Luny.UnityEngine.SceneManagement.LuaScene>(out var _p3_UnityEngine_SceneManagement_Scene))
                        {
                            ...
                            if (_arg4.TryRead<global::System.Int32>(out var _p4_System_Int32))
                            {
                                if (_argCount == 6)
                                {
                                    ...
                                    var previousScene = _p1_UnityEngine_SceneManagement_Scene.Value;
                                    var previousParentInstanceId = _p2_System_Int32;
                                    var newScene = _p3_UnityEngine_SceneManagement_Scene.Value;
        ...
        private static global::Lua.LuaTable CreateMetatable()
        {
            ...
            metatable[global::Lua.Runtime.Metamethods.Concat] = global::Luny.LuaMetatable.ConcatMetamethod;
            metatable[global::Lua.Runtime.Metamethods.ToString] = global::Luny.LuaMetatable.ToStringMetamethod;
            metatable[global::Lua.Runtime.Metamethods.Call] = _LuaChangeGameObjectParentEventArgs_new;
            return metatable;
        }
        private static global::Lua.LuaTable s_Metatable;
        public global::Lua.LuaTable Metatable
