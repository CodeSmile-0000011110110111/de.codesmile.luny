...
public abstract class LuaModuleTestsBase
{
	...
	{
		var luaState = LunyRuntime.Singleton.RuntimeLuaState;
	...
	protected LuaValue[] DoFunction(String funcName, params LuaValue[] args)
	{
		...
		return TryInvokeTestFunc(LunyRuntime.Singleton.RuntimeLuaState, testFunction, args);
	}
	...
	{
		var state = LunyRuntime.Singleton.RuntimeLuaState;
